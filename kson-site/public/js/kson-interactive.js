...
import { INTERACTIVE_EDITOR_CONFIG, createEditorConfig, safeAsyncCall } from './kson-editor-config.js';
(function () {
    'use strict';
    ...
    function getActiveEditor() {
        const blocks = document.querySelectorAll('pre[data-editable="true"]');
     ...
     */
    async function createEditor(codeBlock) {
        ...
        try {
            ...
            // Create the editor
            const editorConfig = createEditorConfig(codeBlock, content, `/workspace/${exampleName || 'untitled'}.kson`, INTERACTIVE_EDITOR_CONFIG);
     ...
     */
    async function setupCodeBlock(block) {
        const exampleName = block.getAttribute('data-example');
        ...
        if (block.getAttribute('data-editable') === 'true') {
            ...
            const editorContainer = block.closest('.kson-editor');
    ...
    async function init() {
        ...
        const codeBlocks = document.querySelectorAll('pre[data-example]');
...
//# sourceMappingURL=kson-interactive.js.map