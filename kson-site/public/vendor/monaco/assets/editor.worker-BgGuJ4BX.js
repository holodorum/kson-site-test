...
class c1 {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(t) {
      setTimeout(() => {
        throw t.stack ? Lt.isErrorNoTelemetry(t) ? new Lt(t.message + `
...
function Mn(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: n,
      stack: r,
      noTelemetry: Lt.isErrorNoTelemetry(e),
      cause: i ? Mn(i) : void 0,
      code: e.code
    };
  }
...
const Dn = "Canceled";
function f1(e) {
  return e instanceof g1 ? !0 : e instanceof Error && e.name === Dn && e.message === Dn;
}
...
class Jt extends Error {
  ...
  static is(t) {
    return t instanceof Jt || t instanceof Error && t.name === Jt._name;
  }
  constructor(t) {
    super(t), this.name = Jt._name;
  }
}
...
function xt(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
...
class ht {
  ...
  constructor(t, n) {
    if (this[ui] = "ResourceMap", t instanceof ht)
  ...
  set(t, n) {
    return this.map.set(this.toKey(t), new E1(t, n)), this;
  }
  get(t) {
...
class A1 {
  ...
  get(t, n = me.None) {
    ...
    if (i)
      return n !== me.None && this.touch(i, n), i.value;
  }
  set(t, n, i = me.None) {
    let r = this._map.get(t);
    if (r)
      r.value = n, i !== me.None && this.touch(r, i);
    else {
...
class v1 extends A1 {
  ...
  peek(t) {
    return super.get(t, me.None);
  }
  set(t, n) {
    return super.set(t, n, me.AsNew), this;
  }
  checkTrim() {
...
function U1(e, t = "Unreachable") {
  throw new Error(t);
}
function M1(e, t = "unexpected state") {
  if (!e)
...
(function(e) {
  ...
  e.length = E;
  function* A(R, v, P = R.length) {
    for (v < -R.length && (v = 0), v < 0 && (v += R.length), P < 0 ? P += R.length : P > R.length && (P = R.length); v < P; v++)
      yield R[v];
  }
  e.slice = A;
  function F(R, v = Number.POSITIVE_INFINITY) {
    const P = [];
    if (v === 0)
      return [P, R];
...
class ks {
  ...
  getDisposableData(t) {
    ...
    return n || (n = { parent: null, source: null, isSingleton: !1, value: t, idx: ks.idx++ }, this.livingDisposables.set(t, n)), n;
  }
  trackDisposable(t) {
  ...
  computeLeakingDisposables(t = 10, n) {
    ...
    if (n)
      ...
      const o = /* @__PURE__ */ new Map(), c = [...this.livingDisposables.values()].filter((h) => h.source !== null && !this.getRootParent(h, o).isSingleton);
      if (c.length === 0)
        return;
      const f = new Set(c.map((h) => h.value));
      if (i = c.filter((h) => !(h.parent && f.has(h.parent))), i.length === 0)
    ...
    function r(o) {
      function c(h, _) {
        for (; h.length > 0 && _.some(
          (L) => typeof L == "string" ? L === h[0] : h[0].match(L)
        ); )
          h.shift();
      }
      const f = o.source.split(`
`).map((h) => h.trim().replace("at ", "")).filter((h) => h !== "");
    ...
    for (const o of i) {
      ...
      for (let f = 0; f <= c.length; f++)
        s.add(c.slice(0, f).join(`
`), o);
    }
    i.sort(bt((o) => o.idx, dt));
    let a = "", u = 0;
    for (const o of i.slice(0, t)) {
      ...
      for (let h = 0; h < c.length; h++) {
        let _ = c[h];
        _ = `(shared with ${s.get(c.slice(0, h + 1).join(`
`)).size}/${i.length} leaks) at ${_}`;
        const d = s.get(c.slice(0, h).join(`
`)), b = m1([...d].map((N) => r(N)[h]), (N) => N);
        delete b[c[h]];
        for (const [N, T] of Object.entries(b))
          f.unshift(`    - stacktraces of ${T.length} other leaks continue with ${N}`);
        f.unshift(_);
      }
      a += `
...
class Wt {
  ...
  add(t) {
    ...
    return this._isDisposed ? Wt.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
class ee {
  static {
    this.Undefined = new ee(void 0);
  }
  constructor(t) {
    this.element = t, this.next = ee.Undefined, this.prev = ee.Undefined;
  }
}
class S1 {
  constructor() {
...
const I1 = globalThis.performance.now.bind(globalThis.performance);
class pn {
  static create(t) {
    return new pn(t);
  }
  constructor(t) {
    this._now = t === !1 ? Date.now : I1, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(S) {
    return (U, y = null, I) => {
      ...
      return X = S((K) => {
        if (!W)
          return X ? X.dispose() : W = !0, U.call(y, K);
      }, null, I), W && X.dispose(), X;
    };
  }
  e.once = n;
  function i(S, U) {
    return e.once(e.filter(S, U));
  }
  e.onceIf = i;
  function r(S, U, y) {
    return f((I, W = null, X) => S((K) => I.call(W, U(K)), null, X), y);
  }
  e.map = r;
  function s(S, U, y) {
    return f((I, W = null, X) => S((K) => {
      U(K), I.call(W, K);
    }, null, X), y);
  }
  e.forEach = s;
  function a(S, U, y) {
    return f((I, W = null, X) => S((K) => U(K) && I.call(W, K), null, X), y);
  }
  e.filter = a;
  function u(S) {
    return S;
  ...
  function o(...S) {
    return (U, y = null, I) => {
      const W = F1(...S.map((X) => X((K) => U.call(y, K))));
      return h(W, I);
    };
  }
  e.any = o;
  ...
  function h(S, U) {
    return U instanceof Array ? U.push(S) : U && U.add(S), S;
  }
  function _(S, U, y = 100, I = !1, W = !1, X, K) {
    let le, ge, tt, $t = 0, At;
    const l1 = {
      leakWarningThreshold: X,
      onWillAddFirstListener() {
        le = S((u1) => {
          $t++, ge = U(ge, u1), I && !tt && (zt.fire(ge), ge = void 0), At = () => {
            const o1 = ge;
            ge = void 0, tt = void 0, (!I || $t > 1) && zt.fire(o1), $t = 0;
          }, typeof y == "number" ? (tt && clearTimeout(tt), tt = setTimeout(At, y)) : tt === void 0 && (tt = null, queueMicrotask(At));
        });
      },
      ...
      onDidRemoveLastListener() {
        At = void 0, le.dispose();
      }
    }, zt = new Te(l1);
    return K?.add(zt), zt.event;
  }
  e.debounce = _;
  function L(S, U = 0, y) {
    return e.debounce(S, (I, W) => I ? (I.push(W), I) : [W], U, void 0, !0, void 0, y);
  }
  e.accumulate = L;
  function d(S, U = (I, W) => I === W, y) {
    let I = !0, W;
    return a(S, (X) => {
      const K = I || !U(X, W);
      return I = !1, W = X, K;
  ...
  e.split = b;
  function N(S, U = !1, y = [], I) {
    let W = y.slice(), X = S((ge) => {
      W ? W.push(ge) : le.fire(ge);
    });
    I && I.add(X);
    const K = () => {
      W?.forEach((ge) => le.fire(ge)), W = null;
    }, le = new Te({
      onWillAddFirstListener() {
        X || (X = S((ge) => le.fire(ge)), I && I.add(X));
      },
    ...
    return I && I.add(le), le.event;
  }
  e.buffer = N;
  function T(S, U) {
    return (I, W, X) => {
      const K = U(new A());
      return S(function(le) {
        const ge = K.evaluate(le);
        ge !== E && I.call(W, ge);
      }, void 0, X);
    };
  }
  ...
  class A {
    ...
    forEach(U) {
      return this.steps.push((y) => (U(y), y)), this;
    }
    filter(U) {
      return this.steps.push((y) => U(y) ? y : E), this;
    }
    reduce(U, y) {
      let I = y;
      return this.steps.push((W) => (I = U(I, W), I)), this;
    }
    latch(U = (y, I) => y === I) {
      let y = !0, I;
      return this.steps.push((W) => {
        const X = y || !U(W, I);
        return y = !1, I = W, X ? W : E;
      }), this;
    }
    evaluate(U) {
  ...
  function F(S, U, y = (I) => I) {
    const I = (...le) => K.fire(y(...le)), W = () => S.on(U, I), X = () => S.removeListener(U, I), K = new Te(
      { onWillAddFirstListener: W, onDidRemoveLastListener: X }
    );
    return K.event;
  }
  e.fromNodeEventEmitter = F;
  function D(S, U, y = (I) => I) {
    const I = (...le) => K.fire(y(...le)), W = () => S.addEventListener(U, I), X = () => S.removeEventListener(U, I), K = new Te(
      { onWillAddFirstListener: W, onDidRemoveLastListener: X }
    );
    return K.event;
  }
  ...
  function B(S, U) {
    let y;
    const I = new Promise((W, X) => {
      const K = n(S)(W, null, U);
      y = () => K.dispose();
    });
    return I.cancel = y, I;
  }
  ...
  function Y(S, U) {
    return new Q(S, U).emitter.event;
  }
  e.fromObservable = Y;
  function $(S) {
    return (U, y, I) => {
      ...
      const K = {
        ...
        endUpdate() {
          W--, W === 0 && (S.reportChanges(), X && (X = !1, U.call(y)));
        },
      ...
      return I instanceof Wt ? I.add(le) : Array.isArray(I) && I.push(le), le;
    };
  }
...
class Cn {
  ...
  constructor(t, n, i = (Cn._idPool++).toString(16).padStart(3, "0")) {
...
class Ln {
  constructor(t) {
    this.value = t, this.id = O1++;
  }
}
const V1 = 2;
class Te {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new Cn(
      t?.onListenerError ?? Ft,
      this._options?.leakWarningThreshold ?? P1
    ) : void 0, this._perfMon = this._options?._profName ? new on(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(u);
        const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new B1(
          `${u}. HINT: Stack shows most frequent listener (${o[1]}-times)`,
          o[0]
        );
        return (this._options?.onListenerError || Ft)(c), ln.None;
      }
      if (this._disposed)
        return ln.None;
      n && (t = t.bind(n));
      const r = new Ln(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = ei.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof Ln ? (this._deliveryQueue ??= new H1(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = Ot(() => {
        s?.(), this._removeListener(r);
      });
      return i instanceof Wt ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }, this._event;
  }
  _removeListener(t) {
  ...
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Ln)
...
const W1 = Ss() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function ci(e, t) {
  let n;
  ...
  }), W1 && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function q(e, t, ...n) {
  return ci(typeof e == "number" ? G1(e, t) : t, n);
}
function G1(e, t) {
  const n = q1()?.[e];
  if (typeof n != "string") {
...
const ft = "en";
let Vt = !1, Ht = !1, Ct = !1, Is = !1, ti = !1, Ps = !1, jt, en = ft, hi = ft, $1, He;
const We = globalThis;
let Re;
typeof We.vscode < "u" && typeof We.vscode.process < "u" ? Re = We.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (Re = process);
const z1 = typeof Re?.versions?.electron == "string", j1 = z1 && Re?.type === "renderer";
if (typeof Re == "object") {
  Vt = Re.platform === "win32", Ht = Re.platform === "darwin", Ct = Re.platform === "linux", Ct && Re.env.SNAP && Re.env.SNAP_REVISION, Re.env.CI || Re.env.BUILD_ARTIFACTSTAGINGDIRECTORY, jt = ft, en = ft;
  const e = Re.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      jt = t.userLocale, hi = t.osLocale, en = t.resolvedLanguage || ft, $1 = t.languagePack?.translationsConfigFile;
    } catch {
    }
  Is = !0;
} else typeof navigator == "object" && !j1 ? (He = navigator.userAgent, Vt = He.indexOf("Windows") >= 0, Ht = He.indexOf("Macintosh") >= 0, Ps = (He.indexOf("Macintosh") >= 0 || He.indexOf("iPad") >= 0 || He.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Ct = He.indexOf("Linux") >= 0, He?.indexOf("Mobi") >= 0, ti = !0, en = Ss() || ft, jt = navigator.language.toLowerCase(), hi = jt) : console.error("Unable to resolve platform.");
var wt;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(wt || (wt = {}));
wt.Web;
Ht ? wt.Mac : Vt ? wt.Windows : Ct && wt.Linux;
const Et = Vt, X1 = Ht, Y1 = Is, Q1 = ti, Z1 = ti && typeof We.importScripts == "function", J1 = Z1 ? We.origin : void 0, ye = He, ze = en;
var fi;
(function(e) {
  function t() {
    return ze;
...
const K1 = typeof We.postMessage == "function" && !We.importScripts;
(() => {
  if (K1) {
    const e = [];
...
Ht || Ps ? St.Macintosh : Vt ? St.Windows : St.Linux;
const C1 = !!(ye && ye.indexOf("Chrome") >= 0);
ye && ye.indexOf("Firefox") >= 0;
!C1 && ye && ye.indexOf("Safari") >= 0;
ye && ye.indexOf("Edg/") >= 0;
ye && ye.indexOf("Android") >= 0;
const ys = Object.freeze(function(e, t) {
...
(function(e) {
  ...
  e.isCancellationToken = t, e.None = Object.freeze({
    ...
    onCancellationRequested: un.None
  }), e.Cancelled = Object.freeze({
    isCancellationRequested: !0,
    onCancellationRequested: ys
  });
})(cn || (cn = {}));
class tn {
  constructor() {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? ys : (this._emitter || (this._emitter = new Te()), this._emitter.event);
  }
  dispose() {
...
class ea {
  ...
  cancel() {
    this._token ? this._token instanceof tn && this._token.cancel() : this._token = cn.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof tn && this._token.dispose() : this._token = cn.None;
  }
}
function ta(e) {
  return e;
...
class na {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = ta) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
function la(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
...
function Os(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
    let o = e.charCodeAt(n), c = t.charCodeAt(r);
    if (o === c)
      continue;
    if (o >= 128 || c >= 128)
      return la(e.toLowerCase(), t.toLowerCase(), n, i, r, s);
    mi(o) && (o -= 32), mi(c) && (c -= 32);
    const f = o - c;
    if (f !== 0)
      return f;
...
function ua(e, t) {
  return e.length === t.length && Os(e, t) === 0;
}
function oa(e, t) {
  const n = t.length;
  return t.length > e.length ? !1 : Os(e, t, 0, n) === 0;
}
function In(e, t) {
...
class Dt {
  ...
  static getInstance() {
    return Dt._INSTANCE || (Dt._INSTANCE = new Dt()), Dt._INSTANCE;
  }
  constructor() {
    this._data = ga();
  }
  getGraphemeBreakType(t) {
    if (t < 32)
      return t === p.LineFeed ? nt.LF : t === p.CarriageReturn ? nt.CR : nt.Control;
    if (t < 127)
      return nt.Other;
...
class Ke {
  ...
  static {
    this._locales = new Sn(() => Object.keys(Ke.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
class Ce {
  ...
  static getData() {
    return this._data || (this._data = new Set([...Object.values(Ce.getRawData())].flat())), this._data;
  }
  ...
  static containsInvisibleCharacter(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t.codePointAt(n);
      if (typeof i == "number" && (Ce.isInvisibleCharacter(i) || i === yn.space))
        return !0;
    }
    return !1;
  }
...
const Nn = "default", ma = "$initialize";
var Le;
(function(e) {
...
class _a {
  constructor(t, n, i, r, s) {
    this.vsWorker = t, this.req = n, this.channel = i, this.method = r, this.args = s, this.type = Le.Request;
  }
}
class _i {
  constructor(t, n, i, r) {
    this.vsWorker = t, this.seq = n, this.res = i, this.err = r, this.type = Le.Reply;
  }
}
class ba {
  constructor(t, n, i, r, s) {
    this.vsWorker = t, this.req = n, this.channel = i, this.eventName = r, this.arg = s, this.type = Le.SubscribeEvent;
  }
}
class da {
  constructor(t, n, i) {
    this.vsWorker = t, this.req = n, this.event = i, this.type = Le.Event;
  }
}
class wa {
  constructor(t, n) {
    this.vsWorker = t, this.req = n, this.type = Le.UnsubscribeEvent;
  }
}
class pa {
  constructor(t) {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new _a(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new Te({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new ba(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new wa(this._workerId, r)), r = null;
      }
    });
    return s.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (Gs(s) ? r[s] = (a) => this.listen(t, s, a) : Ws(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === p.DollarSign && (r[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      ...
      r.detail instanceof Error && (r.detail = Mn(r.detail)), this._send(new _i(this._workerId, n, void 0, Mn(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new da(this._workerId, n, r));
    });
  ...
  _send(t) {
    const n = [];
    if (t.type === Le.Request)
      for (let i = 0; i < t.args.length; i++)
        t.args[i] instanceof ArrayBuffer && n.push(t.args[i]);
    else t.type === Le.Reply && t.res instanceof ArrayBuffer && n.push(t.res);
    this._handler.sendMessage(t, n);
  }
}
function Ws(e) {
  return e[0] === "o" && e[1] === "n" && Vs(e.charCodeAt(2));
}
function Gs(e) {
  return /^onDynamic/.test(e) && Vs(e.charCodeAt(9));
}
class La {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new pa({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === Nn ? this.requestHandler : this._localChannels.get(t);
    if (!r)
...
const Xt = typeof Buffer < "u", Ea = new Sn(() => new Uint8Array(256));
let xn, En;
class xe {
  static alloc(t) {
    return Xt ? new xe(Buffer.allocUnsafe(t)) : new xe(new Uint8Array(t));
  }
  static wrap(t) {
    return Xt && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new xe(t);
  }
  static fromString(t, n) {
    return !(n?.dontUseNodeBuffer || !1) && Xt ? new xe(Buffer.from(t)) : (xn || (xn = new TextEncoder()), new xe(xn.encode(t)));
  }
  static fromByteArray(t) {
    const n = xe.alloc(t.length);
  ...
  clone() {
    const t = xe.alloc(this.byteLength);
    return t.set(this), t;
  }
  toString() {
    return Xt ? this.buffer.toString() : (En || (En = new TextDecoder()), En.decode(this.buffer));
  }
  slice(t, n) {
    return new xe(this.buffer.subarray(t, n));
  }
  set(t, n) {
    if (t instanceof xe)
  ...
  readUInt32BE(t) {
    return Aa(this.buffer, t);
  }
  writeUInt32BE(t, n) {
    va(this.buffer, t, n);
  }
  readUInt32LE(t) {
    return Ta(this.buffer, t);
  }
  writeUInt32LE(t, n) {
    Ua(this.buffer, t, n);
  }
  readUInt8(t) {
    return Ma(this.buffer, t);
  }
  writeUInt8(t, n) {
    Da(this.buffer, t, n);
  }
  indexOf(t, n = 0) {
    return Ra(this.buffer, t instanceof xe ? t.buffer : t, n);
  }
  equals(t) {
...
function Rn(e, t, n = 32) {
  const i = n - t, r = ~((1 << i) - 1);
  return (e << t | (r & e) >>> i) >>> 0;
}
function vt(e, t = 32) {
  return e instanceof ArrayBuffer ? ka(xe.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
}
class $s {
  static {
    ...
    for (s !== 0 ? (a = s, u = -1, s = 0) : (a = t.charCodeAt(0), u = 0); ; ) {
      ...
      if (hn(a))
        if (u + 1 < n) {
          ...
          Pn(c) ? (u++, o = qs(a, c)) : o = ve.UNICODE_REPLACEMENT;
        } else {
          s = a;
          break;
        }
      else Pn(a) && (o = ve.UNICODE_REPLACEMENT);
  ...
  digest() {
    return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, ve.UNICODE_REPLACEMENT)), this._totalLen += this._buffLen, this._wrapUp()), vt(this._h0) + vt(this._h1) + vt(this._h2) + vt(this._h3) + vt(this._h4);
  }
  _wrapUp() {
  ...
  _step() {
    const t = $s._bigBlock32, n = this._buffDV;
    for (let h = 0; h < 64; h += 4)
      t.setUint32(h, n.getUint32(h, !1), !1);
    for (let h = 64; h < 320; h += 4)
      t.setUint32(h, Rn(t.getUint32(h - 12, !1) ^ t.getUint32(h - 32, !1) ^ t.getUint32(h - 56, !1) ^ t.getUint32(h - 64, !1), 1), !1);
    let i = this._h0, r = this._h1, s = this._h2, a = this._h3, u = this._h4, o, c, f;
    for (let h = 0; h < 80; h++)
      h < 20 ? (o = r & s | ~r & a, c = 1518500249) : h < 40 ? (o = r ^ s ^ a, c = 1859775393) : h < 60 ? (o = r & s | r & a | s & a, c = 2400959708) : (o = r ^ s ^ a, c = 3395469782), f = Rn(i, 5) + o + u + c + t.getUint32(h * 4, !1) & 4294967295, u = a, a = s, s = Rn(r, 30), r = i, i = f;
...
function Sa(e, t, n) {
  return new Ze(new wi(e), new wi(t)).ComputeDiff(n).changes;
}
class at {
  static Assert(t, n) {
    if (!t)
...
class pi {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new Xe(
...
class Ze {
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = Ze._getElements(t), [u, o, c] = Ze._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const i = Ze._getStrictElement(this._originalSequence, t), r = Ze._getStrictElement(this._modifiedSequence, n);
    return i === r;
  }
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    const a = [0], u = [0], o = this.ComputeRecursionPoint(t, n, i, r, a, u, s), c = a[0], f = u[0];
    if (o !== null)
      return o;
    if (!s[0]) {
      const h = this.ComputeDiffRecursive(t, c, i, f, s);
      let _ = [];
      return s[0] ? _ = [
        new Xe(
          c + 1,
      ...
      ] : _ = this.ComputeDiffRecursive(c + 1, n, f + 1, r, s), this.ConcatenateChanges(h, _);
    }
    return [
      new Xe(
        t,
  ...
  WALKTRACE(t, n, i, r, s, a, u, o, c, f, h, _, L, d, b, N, T, E) {
    let A = null, F = null, D = new pi(), B = n, R = i, v = L[0] - N[0] - r, P = De.MIN_SAFE_SMALL_INTEGER, Q = this.m_forwardHistory.length - 1;
    do {
      const Y = v + t;
      Y === B || Y < R && c[Y - 1] < c[Y + 1] ? (h = c[Y + 1], d = h - v - r, h < P && D.MarkNextChange(), P = h, D.AddModifiedElement(h + 1, d), v = Y + 1 - t) : (h = c[Y - 1] + 1, d = h - v - r, h < P && D.MarkNextChange(), P = h - 1, D.AddOriginalElement(h, d + 1), v = Y - 1 - t), Q >= 0 && (c = this.m_forwardHistory[Q], t = c[0], B = 1, R = c.length - 1);
    } while (--Q >= -1);
    if (A = D.getReverseChanges(), E[0]) {
      let Y = L[0] + 1, $ = N[0] + 1;
      if (A !== null && A.length > 0) {
        const S = A[A.length - 1];
        Y = Math.max(Y, S.getOriginalEnd()), $ = Math.max($, S.getModifiedEnd());
      }
      F = [
        new Xe(
          Y,
      ...
      D = new pi(), B = a, R = u, v = L[0] - N[0] - o, P = De.MAX_SAFE_SMALL_INTEGER, Q = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const Y = v + s;
        Y === B || Y < R && f[Y - 1] >= f[Y + 1] ? (h = f[Y + 1] - 1, d = h - v - o, h > P && D.MarkNextChange(), P = h + 1, D.AddOriginalElement(h + 1, d + 1), v = Y + 1 - s) : (h = f[Y - 1], d = h - v - o, h > P && D.MarkNextChange(), P = h, D.AddModifiedElement(h + 1, d + 1), v = Y - 1 - s), Q >= 0 && (f = this.m_reverseHistory[Q], s = f[0], B = 1, R = f.length - 1);
      } while (--Q >= -1);
      F = D.getChanges();
    }
    return this.ConcatenateChanges(A, F);
  }
  ComputeRecursionPoint(t, n, i, r, s, a, u) {
    let o = 0, c = 0, f = 0, h = 0, _ = 0, L = 0;
    t--, i--, s[0] = 0, a[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const d = n - t + (r - i), b = d + 1, N = new Int32Array(b), T = new Int32Array(b), E = r - i, A = n - t, F = t - i, D = n - r, R = (A - E) % 2 === 0;
    N[E] = t, T[A] = n, u[0] = !1;
    for (let v = 1; v <= d / 2 + 1; v++) {
      let P = 0, Q = 0;
      f = this.ClipDiagonalBound(E - v, v, E, b), h = this.ClipDiagonalBound(E + v, v, E, b);
      for (let $ = f; $ <= h; $ += 2) {
        $ === f || $ < h && N[$ - 1] < N[$ + 1] ? o = N[$ + 1] : o = N[$ - 1] + 1, c = o - ($ - E) - F;
        const S = o;
        for (; o < n && c < r && this.ElementsAreEqual(o + 1, c + 1); )
          o++, c++;
        if (N[$] = o, o + c > P + Q && (P = o, Q = c), !R && Math.abs($ - A) <= v - 1 && o >= T[$])
          return s[0] = o, a[0] = c, S <= T[$] && qe.MaxDifferencesHistory > 0 && v <= qe.MaxDifferencesHistory + 1 ? this.WALKTRACE(E, f, h, F, A, _, L, D, N, T, o, n, s, c, r, a, R, u) : null;
      }
      const Y = (P - t + (Q - i) - v) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(P, Y))
        return u[0] = !0, s[0] = P, a[0] = Q, Y > 0 && qe.MaxDifferencesHistory > 0 && v <= qe.MaxDifferencesHistory + 1 ? this.WALKTRACE(E, f, h, F, A, _, L, D, N, T, o, n, s, c, r, a, R, u) : (t++, i++, [
          new Xe(
            t,
            n - t + 1,
            i,
      ...
      _ = this.ClipDiagonalBound(A - v, v, A, b), L = this.ClipDiagonalBound(A + v, v, A, b);
      for (let $ = _; $ <= L; $ += 2) {
        $ === _ || $ < L && T[$ - 1] >= T[$ + 1] ? o = T[$ + 1] - 1 : o = T[$ - 1], c = o - ($ - A) - D;
        const S = o;
        for (; o > t && c > i && this.ElementsAreEqual(o, c); )
          o--, c--;
        if (T[$] = o, R && Math.abs($ - E) <= v && o <= N[$])
          return s[0] = o, a[0] = c, S >= N[$] && qe.MaxDifferencesHistory > 0 && v <= qe.MaxDifferencesHistory + 1 ? this.WALKTRACE(E, f, h, F, A, _, L, D, N, T, o, n, s, c, r, a, R, u) : null;
      }
      if (v <= qe.MaxDifferencesHistory) {
        let $ = new Int32Array(h - f + 2);
        $[0] = E - f + 1, lt.Copy2(N, f, $, 1, h - f + 1), this.m_forwardHistory.push($), $ = new Int32Array(L - _ + 2), $[0] = A - _ + 1, lt.Copy2(T, _, $, 1, L - _ + 1), this.m_reverseHistory.push($);
      }
    }
    return this.WALKTRACE(E, f, h, F, A, _, L, D, N, T, o, n, s, c, r, a, R, u);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        const r = t[n - 1], s = t[n], a = s.originalStart - r.originalStart - r.originalLength, u = r.originalStart, o = s.originalStart + s.originalLength, c = o - u, f = r.modifiedStart, h = s.modifiedStart + s.modifiedLength, _ = h - f;
        if (a < 5 && c < 20 && _ < 20) {
          const L = this._findBetterContiguousSequence(u, c, f, _, a);
          if (L) {
            const [d, b] = L;
            (d !== r.originalStart + r.originalLength || b !== r.modifiedStart + r.modifiedLength) && (r.originalLength = d - r.originalStart, r.modifiedLength = b - r.modifiedStart, s.originalStart = d + a, s.modifiedStart = b + a, s.originalLength = o - s.originalStart, s.modifiedLength = h - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, i) {
    if (at.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), at.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (u = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Xe(r, s, a, u), !0;
    } else
      return i[0] = null, !1;
  }
...
class k {
  ...
  static intersectRanges(t, n) {
    ...
    const u = n.startLineNumber, o = n.startColumn, c = n.endLineNumber, f = n.endColumn;
    return i < u ? (i = u, r = o) : i === u && (r = Math.max(r, o)), s > c ? (s = c, a = f) : s === c && (a = Math.min(a, f)), i > s || i === s && r > a ? null : new k(
      i,
      r,
      s,
      a
...
class ni {
  constructor(t) {
    const n = gi(t);
    this._defaultValue = n, this._asciiMap = ni._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
...
function Ba() {
  if (Tt === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < e.length; n++)
      Tt.set(e.charCodeAt(n), te.ForceTermination);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      Tt.set(t.charCodeAt(n), te.CannotEndIn);
  }
  return Tt;
}
class fn {
  ...
  static computeLinks(t, n = ya()) {
    const i = Ba(), r = [];
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      const u = t.getLineContent(s), o = u.length;
      let c = 0, f = 0, h = 0, _ = V.Start, L = !1, d = !1, b = !1, N = !1;
      for (; c < o; ) {
        let T = !1;
        const E = u.charCodeAt(c);
        if (_ === V.Accept) {
          let A;
          switch (E) {
            case p.OpenParen:
              ...
              break;
            case p.CloseParen:
              A = L ? te.None : te.ForceTermination;
              break;
            case p.OpenSquareBracket:
              b = !0, d = !0, A = te.None;
              break;
            case p.CloseSquareBracket:
              b = !1, A = d ? te.None : te.ForceTermination;
              break;
            case p.OpenCurlyBrace:
              N = !0, A = te.None;
              break;
            case p.CloseCurlyBrace:
              A = N ? te.None : te.ForceTermination;
              break;
            case p.SingleQuote:
            case p.DoubleQuote:
            case p.BackTick:
              h === E ? A = te.ForceTermination : h === p.SingleQuote || h === p.DoubleQuote || h === p.BackTick ? A = te.None : A = te.ForceTermination;
              break;
            case p.Asterisk:
              A = h === p.Asterisk ? te.ForceTermination : te.None;
              break;
            case p.Pipe:
              A = h === p.Pipe ? te.ForceTermination : te.None;
              break;
            case p.Space:
              A = b ? te.None : te.ForceTermination;
              break;
            default:
              A = i.get(E);
          }
          A === te.ForceTermination && (r.push(fn._createLink(i, u, s, f, c)), T = !0);
        } else if (_ === V.End) {
          let A;
          E === p.OpenSquareBracket ? (d = !0, A = te.None) : A = i.get(E), A === te.ForceTermination ? T = !0 : _ = V.Accept;
        } else
          _ = n.nextState(_, E), _ === V.Invalid && (T = !0);
        T && (_ = V.Start, L = !1, d = !1, N = !1, f = c + 1, h = E), c++;
      }
      _ === V.Accept && r.push(fn._createLink(i, u, s, f, o));
    }
    return r;
  }
}
function Oa(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : fn.computeLinks(e);
}
class ii {
  constructor() {
...
const nn = new ri(), On = new ri(), Vn = new ri(), Va = new Array(230), Ha = /* @__PURE__ */ Object.create(null), qa = /* @__PURE__ */ Object.create(null), Hn = [];
for (let e = 0; e <= m.MAX_VALUE; e++)
  g.DependsOnKbLayout;
for (let e = 0; e <= g.MAX_VALUE; e++)
  Hn[e] = m.DependsOnKbLayout;
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    const [s, a, u, o, c, f, h, _, L] = r;
    if (i[a] || (i[a] = !0, Ha[u] = a, qa[u.toLowerCase()] = a, s && o !== g.Unknown && o !== g.Enter && o !== g.Ctrl && o !== g.Shift && o !== g.Alt && o !== g.Meta && (Hn[o] = a)), !n[o]) {
      if (n[o] = !0, !c)
        throw new Error(
          `String representation missing for key code ${o} around scan code ${u}`
        );
      nn.define(o, c), On.define(o, _ || c), Vn.define(o, L || _ || c);
    }
    f && (Va[f] = o);
  }
  Hn[g.Enter] = m.Enter;
...
(function(e) {
  ...
  e.toString = t;
  function n(u) {
    return nn.strToKeyCode(u);
  }
  e.fromString = n;
  function i(u) {
    return On.keyCodeToStr(u);
  }
  e.toUserSettingsUS = i;
  function r(u) {
    return Vn.keyCodeToStr(u);
  }
  e.toUserSettingsGeneral = r;
  function s(u) {
    return On.strToKeyCode(u) || Vn.strToKeyCode(u);
  }
...
if (typeof vn < "u" && typeof vn.process < "u") {
  ...
  get platform() {
    return Et ? "win32" : X1 ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
const gn = it.cwd, Ga = it.env, $a = it.platform;
it.arch;
const za = 65, ja = 97, Xa = 90, Ya = 122, rt = 46, ue = 47, we = 92, Be = 58, Qa = 63;
...
function mn(e, t, n, i) {
  ...
  for (let c = 0; c <= e.length; ++c) {
    ...
    if (i(o)) {
      if (!(a === c - 1 || u === 1)) if (u === 2) {
        if (r.length < 2 || s !== 2 || r.charCodeAt(r.length - 1) !== rt || r.charCodeAt(r.length - 2) !== rt) {
          if (r.length > 2) {
            const f = r.lastIndexOf(n);
            f === -1 ? (r = "", s = 0) : (r = r.slice(0, f), s = r.length - 1 - r.lastIndexOf(n)), a = c, u = 0;
            continue;
          } else if (r.length !== 0) {
            r = "", s = 0, a = c, u = 0;
            continue;
...
function js(e, t) {
  Za(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${Ja(t.ext)}`;
...
const he = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        if (s = e[r], se(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = gn() : (s = Ga[`=${t}`] || gn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === we) && (s = `${t}\\`));
      const a = s.length;
      let u = 0, o = "", c = !1;
      ...
      if (a === 1)
        ...
        if (c = !0, j(s.charCodeAt(1))) {
          ...
          u = 1;
      else Oe(f) && s.charCodeAt(1) === Be && (o = s.slice(0, 2), u = 2, a > 2 && j(s.charCodeAt(2)) && (c = !0, u = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (j(s))
      if (r = !0, j(e.charCodeAt(1))) {
        ...
        n = 1;
    else Oe(s) && e.charCodeAt(1) === Be && (i = e.slice(0, 2), n = 2, t > 2 && j(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? mn(e.slice(n), !r, "\\", j) : "";
    if (a.length === 0 && !r && (a = "."), a.length > 0 && j(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":")) {
      if (a.length >= 2 && Oe(a.charCodeAt(0)) && a.charCodeAt(1) === Be)
        return `.\\${a}`;
      let u = e.indexOf(":");
      do
  ...
  isAbsolute(e) {
    ...
    return j(n) || t > 2 && Oe(n) && e.charCodeAt(1) === Be && j(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    ...
    if (n.length !== e.length || i.length !== t.length) {
      ...
      const N = d.length, T = b.length, E = N < T ? N : T;
      let A;
      for (A = 0; A < E && d[A].toLowerCase() === b[A].toLowerCase(); A++)
        ;
      return A === 0 ? i : A === E ? T > E ? b.slice(A).join("\\") : N > E ? "..\\".repeat(N - 1 - A) + ".." : "" : "..\\".repeat(N - A) + b.slice(A).join("\\");
    }
    let r = 0;
    ...
    if (_ !== f) {
      ...
      a > f && (e.charCodeAt(r + _) === we ? h = _ : _ === 2 && (h = 3)), h === -1 && (h = 0);
    }
    let L = "";
    for (_ = r + h + 1; _ <= s; ++_)
      (_ === s || e.charCodeAt(_) === we) && (L += L.length === 0 ? ".." : "\\..");
    return u += h, L.length > 0 ? `${L}${i.slice(u, o)}` : (i.charCodeAt(u) === we && ++u, i.slice(u, o));
  },
  toNamespacedPath(e) {
    ...
    } else if (Oe(t.charCodeAt(0)) && t.charCodeAt(1) === Be && t.charCodeAt(2) === we)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else Oe(r) && e.charCodeAt(1) === Be && (n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let u = t - 1; u >= i; --u)
      if (j(e.charCodeAt(u))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && Oe(e.charCodeAt(0)) && e.charCodeAt(1) === Be && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === Be && Oe(e.charCodeAt(0)) && (t = i = 2);
    for (let u = e.length - 1; u >= t; --u) {
      ...
      r === -1 && (s = !1, r = u + 1), o === rt ? n === -1 ? n = u : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Oe(r) && e.charCodeAt(1) === Be) {
      if (n <= 2)
    ...
    let s = -1, a = i, u = -1, o = !0, c = e.length - 1, f = 0;
    for (; c >= i; --c) {
      ...
      u === -1 && (o = !1, u = c + 1), r === rt ? s === -1 ? s = c : f !== 1 && (f = 1) : s !== -1 && (f = -1);
    }
    return u !== -1 && (s === -1 || f === 0 || f === 1 && s === u - 1 && s === a + 1 ? t.base = t.name = e.slice(a, u) : (t.name = e.slice(a, s), t.base = e.slice(a, u), t.ext = e.slice(s, u))), a > 0 && a !== i ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    return t = mn(t, !n, "/", Wn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (se(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ue, n = e.charCodeAt(e.length - 1) === ue;
    return e = mn(e, !t, "/", Wn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  relative(e, t) {
    if (se(e, "from"), se(t, "to"), e === t || (e = ne.resolve(e), t = ne.resolve(t), e === t))
      return "";
    ...
    let f = "";
    for (c = n + o + 1; c <= i; ++c)
      (c === i || e.charCodeAt(c) === ue) && (f += f.length === 0 ? ".." : "/..");
    return `${f}${t.slice(s + o)}`;
  },
  toNamespacedPath(e) {
    return e;
  },
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (u = !1, a = o + 1), f === rt ? r === -1 ? r = o : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (a !== -1) {
      const f = s === 0 && n ? 1 : s;
      r === -1 || c === 0 || c === 1 && r === a - 1 && r === s + 1 ? t.base = t.name = e.slice(f, a) : (t.name = e.slice(f, r), t.base = e.slice(f, a), t.ext = e.slice(r, a));
    }
...
ne.win32 = he.win32 = he;
ne.posix = he.posix = ne;
const Ca = Ie ? he.normalize : ne.normalize;
Ie ? he.isAbsolute : ne.isAbsolute;
const el = Ie ? he.join : ne.join, tl = Ie ? he.resolve : ne.resolve, nl = Ie ? he.relative : ne.relative, il = Ie ? he.dirname : ne.dirname;
Ie ? he.basename : ne.basename;
Ie ? he.extname : ne.extname;
Ie ? he.parse : ne.parse;
const rn = Ie ? he.sep : ne.sep, rl = /^\w[\w\d+.-]*$/, sl = /^\//, al = /^\/\//;
function ll(e, t) {
  if (!e.scheme && t)
    throw new Error(
...
class ce {
  ...
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || C, this.authority = t.authority || C, this.path = t.path || C, this.query = t.query || C, this.fragment = t.fragment || C) : (this.scheme = ul(t, a), this.authority = n || C, this.path = ol(this.scheme, i || C), this.query = r || C, this.fragment = s || C, ll(this, a));
  }
  get fsPath() {
    return _n(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = C), i === void 0 ? i = this.authority : i === null && (i = C), r === void 0 ? r = this.path : r === null && (r = C), s === void 0 ? s = this.query : s === null && (s = C), a === void 0 ? a = this.fragment : a === null && (a = C), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new ut(n, i, r, s, a);
  }
  static parse(t, n = !1) {
    const i = cl.exec(t);
    return i ? new ut(
  ...
  static file(t) {
    let n = C;
    if (Et && (t = t.replace(/\\/g, Fe)), t[0] === Fe && t[1] === Fe) {
      const i = t.indexOf(Fe, 2);
      i === -1 ? (n = t.substring(2), t = Fe) : (n = t.substring(2, i), t = t.substring(i) || Fe);
    }
    return new ut("file", n, t, C, C);
  }
  static from(t, n) {
    return new ut(
      t.scheme,
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return Et && t.scheme === "file" ? i = ce.file(he.join(_n(t, !0), ...n)).path : i = ne.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return Gn(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new ut(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Xs ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
...
const Xs = Et ? 1 : void 0;
class ut extends ce {
  constructor() {
    super(...arguments), this._formatted = null, this._fsPath = null;
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = _n(this, !1)), this._fsPath;
  }
  toString(t = !1) {
    return t ? Gn(this, !0) : (this._formatted || (this._formatted = Gn(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: qn.Uri
    };
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Xs), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const Ys = {
  [p.Colon]: "%3A",
...
function hl(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === p.Hash || i === p.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += Ys[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function _n(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === p.Slash && (e.path.charCodeAt(1) >= p.A && e.path.charCodeAt(1) <= p.Z || e.path.charCodeAt(1) >= p.a && e.path.charCodeAt(1) <= p.z) && e.path.charCodeAt(2) === p.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Et && (n = n.replace(/\//g, "\\")), n;
}
function Gn(e, t) {
  const n = t ? hl : xi;
  ...
  if (r && (i += r, i += ":"), (s || r === "file") && (i += Fe, i += Fe), s) {
    ...
    if (c !== -1) {
      ...
      s = s.substr(c + 1), c = f.lastIndexOf(":"), c === -1 ? i += n(f, !1, !1) : (i += n(f.substr(0, c), !1, !1), i += ":", i += n(f.substr(c + 1), !1, !0)), i += "@";
    }
  ...
  return u && (i += "?", i += n(u, !1, !1)), o && (i += "#", i += t ? o : xi(o, !1, !1)), i;
}
function Qs(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + Qs(e.substr(3)) : e;
  }
}
const Ei = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Yt(e) {
  return e.match(Ei) ? e.replace(Ei, (t) => Qs(t)) : e;
}
var Qe;
(function(e) {
...
class Ee extends k {
  ...
  getDirection() {
    return this.selectionStartLineNumber === this.startLineNumber && this.selectionStartColumn === this.startColumn ? Qe.LTR : Qe.RTL;
  }
  setEndPosition(t, n) {
    return this.getDirection() === Qe.LTR ? new Ee(this.startLineNumber, this.startColumn, t, n) : new Ee(t, n, this.startLineNumber, this.startColumn);
  }
  getPosition() {
  ...
  setStartPosition(t, n) {
    return this.getDirection() === Qe.LTR ? new Ee(t, n, this.endLineNumber, this.endColumn) : new Ee(this.endLineNumber, this.endColumn, t, n);
  }
  static fromPositions(t, n = t) {
    return new Ee(t.lineNumber, t.column, n.lineNumber, n.column);
  }
  static fromRange(t, n) {
    return n === Qe.LTR ? new Ee(
      t.startLineNumber,
      t.startColumn,
      t.endLineNumber,
      t.endColumn
  ...
  static createWithDirection(t, n, i, r, s) {
    return s === Qe.LTR ? new Ee(t, n, i, r) : new Ee(i, r, t, n);
  }
}
...
class ml {
  ...
  getDefaultBackground() {
    return this._colorMap && this._colorMap.length > bn.DefaultBackground ? this._colorMap[bn.DefaultBackground] : null;
  }
}
class _l extends ln {
  get isResolved() {
  ...
  function i(a) {
    switch (a) {
      case x.Method:
        return q(765, "Method");
      case x.Function:
        return q(766, "Function");
      case x.Constructor:
        return q(767, "Constructor");
      case x.Field:
        return q(768, "Field");
      case x.Variable:
        return q(769, "Variable");
      case x.Class:
        return q(770, "Class");
      case x.Struct:
        return q(771, "Struct");
      case x.Interface:
        return q(772, "Interface");
      case x.Module:
        return q(773, "Module");
      case x.Property:
        return q(774, "Property");
      case x.Event:
        return q(775, "Event");
      case x.Operator:
        return q(776, "Operator");
      case x.Unit:
        return q(777, "Unit");
      case x.Value:
        return q(778, "Value");
      case x.Constant:
        return q(779, "Constant");
      case x.Enum:
        return q(780, "Enum");
      case x.EnumMember:
        return q(781, "Enum Member");
      case x.Keyword:
        return q(782, "Keyword");
      case x.Text:
        return q(783, "Text");
      case x.Color:
        return q(784, "Color");
      case x.File:
        return q(785, "File");
      case x.Reference:
        return q(786, "Reference");
      case x.Customcolor:
        return q(787, "Custom Color");
      case x.Folder:
        return q(788, "Folder");
      case x.TypeParameter:
        return q(789, "Type Parameter");
      case x.User:
        return q(790, "User");
      case x.Issue:
        return q(791, "Issue");
...
M.Array + "", q(794, "array"), M.Boolean + "", q(795, "boolean"), M.Class + "", q(796, "class"), M.Constant + "", q(797, "constant"), M.Constructor + "", q(798, "constructor"), M.Enum + "", q(799, "enumeration"), M.EnumMember + "", q(800, "enumeration member"), M.Event + "", q(801, "event"), M.Field + "", q(802, "field"), M.File + "", q(803, "file"), M.Function + "", q(804, "function"), M.Interface + "", q(805, "interface"), M.Key + "", q(806, "key"), M.Method + "", q(807, "method"), M.Module + "", q(808, "module"), M.Namespace + "", q(809, "namespace"), M.Null + "", q(810, "null"), M.Number + "", q(811, "number"), M.Object + "", q(812, "object"), M.Operator + "", q(813, "operator"), M.Package + "", q(814, "package"), M.Property + "", q(815, "property"), M.String + "", q(816, "string"), M.Struct + "", q(817, "struct"), M.TypeParameter + "", q(818, "type parameter"), M.Variable + "", q(819, "variable");
var qi;
(function(e) {
  e[e.Deprecated = 1] = "Deprecated";
})(qi || (qi = {}));
...
(function(e) {
  ...
  i.set(M.File, x.File), i.set(M.Module, x.Module), i.set(M.Namespace, x.Module), i.set(M.Package, x.Module), i.set(M.Class, x.Class), i.set(M.Method, x.Method), i.set(M.Property, x.Property), i.set(M.Field, x.Field), i.set(M.Constructor, x.Constructor), i.set(M.Enum, x.Enum), i.set(M.Interface, x.Interface), i.set(M.Function, x.Function), i.set(M.Variable, x.Variable), i.set(M.Constant, x.Constant), i.set(M.String, x.Text), i.set(M.Number, x.Value), i.set(M.Boolean, x.Value), i.set(M.Array, x.Value), i.set(M.Object, x.Value), i.set(M.Key, x.Keyword), i.set(M.Null, x.Value), i.set(M.EnumMember, x.EnumMember), i.set(M.Struct, x.Struct), i.set(M.Event, x.Event), i.set(M.Operator, x.Operator), i.set(M.TypeParameter, x.TypeParameter);
  function r(s) {
    let a = i.get(s);
...
function Ll(e, t, n, i, r) {
  ...
  if (e.get(s) !== Rt.Regular || s === p.CarriageReturn || s === p.LineFeed)
    return !0;
  if (r > 0) {
    const a = t.charCodeAt(i);
    if (e.get(a) !== Rt.Regular)
      return !0;
  }
  return !1;
}
...
function xl(e, t, n, i, r) {
  return Ll(e, t, n, i, r) && Nl(e, t, n, i, r);
}
class El {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || xl(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
...
function si(e, t, n, i, r) {
  if (t = Js(t), r || (r = an.first(Ks)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
...
class Tl {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new es(n), u = a.getCandidateCodePoints();
    let o;
    u === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${Ul(Array.from(u))}`, "g");
    const c = new El(null, o), f = [];
    let h = !1, _, L = 0, d = 0, b = 0;
    e: for (let N = r, T = s; N <= T; N++) {
      const E = t.getLineContent(N), A = E.length;
      c.reset(0);
      do
        if (_ = c.next(E), _) {
          let F = _.index, D = _.index + _[0].length;
          if (F > 0) {
            const P = E.charCodeAt(F - 1);
            hn(P) && F--;
          }
          if (D + 1 < A) {
            const P = E.charCodeAt(D - 1);
            hn(P) && D++;
          }
          const B = E.substring(F, D);
          let R = si(F + 1, Zs, E, 0);
          R && R.endColumn <= F + 1 && (R = null);
          const v = a.shouldHighlightNonBasicASCII(B, R ? R.word : null);
          if (v !== _e.None) {
            if (v === _e.Ambiguous ? L++ : v === _e.Invisible ? d++ : v === _e.NonBasicASCII ? b++ : U1(), f.length >= 1e3) {
              h = !0;
              break e;
            }
            f.push(new k(N, F + 1, N, D + 1));
          }
        }
      while (_);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      case _e.None:
        return null;
      case _e.Invisible:
        return { kind: It.Invisible };
      case _e.Ambiguous: {
        const s = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(s), u = Ke.getLocales().filter((o) => !Ke.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
        return { kind: It.Ambiguous, confusableWith: String.fromCodePoint(a), notAmbiguousInLocales: u };
      }
      case _e.NonBasicASCII:
        return { kind: It.NonBasicAscii };
    }
  }
}
function Ul(e, t) {
  return `[${ia(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
var It;
(function(e) {
...
class es {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ce.codePoints)
        ts(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const u = a.codePointAt(0), o = fa(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(u) && !Ce.isInvisibleCharacter(u) && (s = !0);
      }
    return !r && s ? _e.None : this.options.invisibleCharacters && !ts(t) && Ce.isInvisibleCharacter(i) ? _e.Invisible : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? _e.Ambiguous : _e.None;
  }
}
function ts(e) {
  return e === " " || e === `
...
class H {
  ...
  joinRightTouching(t) {
    ...
    return new H(this.start, t.endExclusive);
  }
}
class G {
  static ofLength(t, n) {
  ...
  static {
    this.compareByStart = bt((t) => t.startLineNumber, dt);
  }
  static subtract(t, n) {
...
class Pe {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = kn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = xt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(t) {
    const n = Nt(this._normalizedRanges, (i) => i.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = Nt(this._normalizedRanges, (i) => i.startLineNumber < t.endLineNumberExclusive);
  ...
  getUnion(t) {
    ...
    for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new G(
        s.startLineNumber,
  ...
  subtractFrom(t) {
    const n = kn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = xt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Pe([t]);
    const r = [];
    ...
    for (let a = n; a < i; a++) {
      ...
      u.startLineNumber > s && r.push(new G(s, u.startLineNumber)), s = u.endLineNumberExclusive;
    }
    return s < t.endLineNumberExclusive && r.push(new G(s, t.endLineNumberExclusive)), new Pe(r);
  }
  toString() {
...
class Cs {
    ...
    for (const u of i.replacements) {
      ...
      for (; ; ) {
        ...
        if (!h || h.replaceRange.start + a > u.replaceRange.endExclusive)
          break;
        c || (c = h), f = h, r.shift(), a += h.getNewLength() - h.replaceRange.length;
      }
      if (!c)
        s.push(u.delta(-a));
      else {
        ...
        if (_ > 0) {
          const N = c.slice(H.emptyAt(h), new H(0, _));
          s.push(N);
        }
        if (!f)
          throw new ae("Invariant violation: lastIntersecting is undefined");
        const L = f.replaceRange.endExclusive + a - u.replaceRange.endExclusive;
        if (L > 0) {
          const N = f.slice(H.ofStartAndLength(f.replaceRange.endExclusive, 0), new H(
            f.getNewLength() - L,
            f.getNewLength()
          ));
          r.unshift(N), a -= N.getNewLength() - N.replaceRange.length;
        }
        const d = new H(h, u.replaceRange.endExclusive - a), b = u.slice(d, new H(0, u.getNewLength()));
        s.push(b);
      }
    }
    for (; ; ) {
  ...
  getNewRanges() {
    ...
    let n = 0;
    for (const i of this.replacements)
      t.push(H.ofStartAndLength(i.replaceRange.start + n, i.getNewLength())), n += i.getLengthDelta();
    return t;
  }
  ...
  getLengthDelta() {
    return x1(this.replacements, (t) => t.getLengthDelta());
  }
  getNewDataLength(t) {
...
class Ml {
  ...
  delta(t) {
    return this.slice(this.replaceRange.delta(t), new H(0, this.getNewLength()));
  }
  getLengthDelta() {
  ...
  getRangeAfterReplace() {
    return new H(this.replaceRange.start, this.replaceRange.start + this.getNewLength());
  }
}
class kt extends Cs {
  static {
...
class pe extends Cs {
  ...
  static replace(t, n) {
    return new pe([new be(t, n)]);
  }
  static insert(t, n) {
    return new pe([new be(H.emptyAt(t), n)]);
  }
  static delete(t) {
    return new pe([new be(t, "")]);
  }
  static fromJson(t) {
    return new pe(t.map(be.fromJson));
  }
  static compose(t) {
    if (t.length === 0)
      return pe.empty;
  ...
  inverse(t) {
    ...
    for (const r of this.replacements)
      n.push(new be(
        H.ofStartAndLength(r.replaceRange.start + i, r.newText.length),
  ...
  tryRebase(t, n) {
    ...
    for (; s < this.replacements.length || r < t.replacements.length; ) {
      ...
      if (o)
        if (!u)
          i.push(new be(o.replaceRange.delta(a), o.newText)), s++;
        else if (o.replaceRange.intersectsOrTouches(u.replaceRange)) {
          if (s++, n)
            return;
        } else o.replaceRange.start < u.replaceRange.start ? (i.push(new be(o.replaceRange.delta(a), o.newText)), s++) : (r++, a += u.newText.length - u.replaceRange.length);
      else break;
    }
    return new pe(i);
  }
  toJson() {
    return this.replacements.map((t) => ({
      txt: t.newText,
      pos: t.replaceRange.start,
      len: t.replaceRange.length
    }));
  }
  isNeutralOn(t) {
...
class be extends Ml {
  static insert(t, n) {
    return new be(H.emptyAt(t), n);
  }
  static replace(t, n) {
    return new be(t, n);
  }
  static fromJson(t) {
    return new be(H.ofStartAndLength(t.pos, t.len), t.txt);
  }
  constructor(t, n) {
  ...
  slice(t, n) {
    return new be(t, n.substring(this.newText));
  }
  toString() {
  ...
  removeCommonSuffixPrefix(t) {
    const n = t.substring(this.replaceRange.start, this.replaceRange.endExclusive), i = In(n, this.newText), r = Math.min(n.length - i, this.newText.length - i, Hs(n, this.newText)), s = new H(
...
class Dl {
  ...
  getStringReplacement(t) {
    return new be(this.getOffsetRange(t.range), t.text);
  }
  getSingleTextEdit(t) {
    return new Ae(this.getRange(t.replaceRange), t.newText);
  }
  getTextEdit(t) {
    const n = t.replacements.map((i) => this.getSingleTextEdit(i));
    return new Je(n);
  }
}
class e1 extends Dl {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  _validatePosition(t) {
    ...
    if (t.column < 1)
      return new z(t.lineNumber, 1);
    const i = this.getLineLength(t.lineNumber);
    return t.column - 1 > i ? new z(t.lineNumber, i + 1) : t;
  }
  getPosition(t) {
    const n = xt(this.lineStartOffsetByLineIdx, (s) => s <= t), i = n + 1, r = t - this.lineStartOffsetByLineIdx[n] + 1;
    return new z(i, r);
  }
  getTextLength(t) {
    return oe.ofRange(this.getRange(t));
  }
  get textLength() {
    const t = this.lineStartOffsetByLineIdx.length - 1;
    return new oe(t, this.text.length - this.lineStartOffsetByLineIdx[t]);
  }
  getLineLength(t) {
...
class t1 {
  ...
  get endPositionExclusive() {
    return this.length.addToPosition(new z(1, 1));
  }
  get lineRange() {
  ...
  getTransformer() {
    return this._transformer || (this._transformer = new e1(this.getValue())), this._transformer;
  }
  getLineAt(t) {
...
class kl extends t1 {
  constructor(t, n) {
    M1(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
` + this._getLineContent(t.endLineNumber).substring(0, t.endColumn - 1), n;
  ...
  get length() {
    ...
    return new oe(this._lineCount - 1, t.length);
  }
}
class Qt extends kl {
  constructor(t) {
...
class ns extends t1 {
  constructor(t) {
    super(), this.value = t, this._t = new e1(this.value);
  }
  getValueOfRange(t) {
...
class Je {
  static fromStringEdit(t, n) {
    const i = t.replacements.map((r) => new Ae(n.getTransformer().getRange(r.replaceRange), r.newText));
    return new Je(i);
  }
  static replace(t, n) {
    return new Je([new Ae(t, n)]);
  }
  static insert(t, n) {
    return new Je([new Ae(k.fromPositions(t, t), n)]);
  }
  constructor(t) {
    this.replacements = t, Bt(() => Kn(t, (n, i) => n.range.getEndPosition().isBeforeOrEqual(i.range.getStartPosition())));
  }
  normalize() {
    const t = [];
    for (const n of this.replacements)
      if (t.length > 0 && t[t.length - 1].range.getEndPosition().equals(n.range.getStartPosition())) {
        ...
        t[t.length - 1] = new Ae(i.range.plusRange(n.range), i.text + n.text);
  ...
  mapPosition(t) {
    ...
    for (const s of this.replacements) {
      ...
      if (t.isBeforeOrEqual(a))
        break;
      const u = s.range.getEndPosition(), o = oe.ofText(s.text);
      if (t.isBefore(u)) {
        const c = new z(
          a.lineNumber + n,
  ...
  mapRange(t) {
    function n(a) {
      return a instanceof z ? a : a.getStartPosition();
    }
    function i(a) {
      return a instanceof z ? a : a.getEndPosition();
    }
  ...
  apply(t) {
    let n = "", i = new z(1, 1);
    for (const s of this.replacements) {
      const a = s.range, u = a.getStartPosition(), o = a.getEndPosition(), c = Zt(i, u);
      c.isEmpty() || (n += t.getValueOfRange(c)), n += s.text, i = o;
    }
    const r = Zt(i, t.endPositionExclusive);
  ...
  inverse(t) {
    ...
    return new Je(this.replacements.map((i, r) => new Ae(n[r], t.getValueOfRange(i.range))));
  }
  getNewRanges() {
    const t = [];
    let n = 0, i = 0, r = 0;
    for (const s of this.replacements) {
      const a = oe.ofText(s.text), u = z.lift({
  ...
  toReplacement(t) {
    ...
    return new Ae(k.fromPositions(n, i), r);
  }
  equals(t) {
    return Ms(this.replacements, t.replacements, (n, i) => n.equals(i));
  }
  toString(t) {
    return t === void 0 ? this.replacements.map((n) => n.toString()).join(`
`) : typeof t == "string" ? this.toString(new ns(t)) : this.replacements.length === 0 ? "" : this.replacements.map((n) => {
      const r = t.getValueOfRange(n.range), s = k.fromPositions(new z(Math.max(1, n.range.startLineNumber - 1), 1), n.range.getStartPosition());
      let a = t.getValueOfRange(s);
      a.length > 10 && (a = "..." + a.substring(a.length - 10));
      const u = k.fromPositions(n.range.getEndPosition(), new z(n.range.endLineNumber + 1, 1));
      ...
      if (f.length > 10) {
        const h = Math.floor(5);
        f = f.substring(0, h) + "..." + f.substring(f.length - h);
      }
      return c.length === 0 ? `${a}❰${f}❱${o}` : `${a}❰${c}↦${f}❱${o}`;
    }).join(`
`);
  }
}
  ...
  static joinReplacements(t, n) {
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      if (s += u.text, a < t.length - 1) {
        const o = t[a + 1], c = k.fromPositions(u.range.getEndPosition(), o.range.getStartPosition()), f = n.getValueOfRange(c);
        s += f;
      }
    }
    return new Ae(k.fromPositions(i, r), s);
  }
  constructor(t, n) {
...
`, `
`), r = In(n, i), s = oe.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r), u = k.fromPositions(s, this.range.getEndPosition());
    return new Ae(u, a);
  }
...
class Me {
  static inverse(t, n, i) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const c = new Me(new G(s, o.original.startLineNumber), new G(a, o.modified.startLineNumber));
      c.modified.isEmpty || r.push(c), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const u = new Me(new G(s, n + 1), new G(a, i + 1));
  ...
  toRangeMapping2(t, n) {
    if (is(this.original.endLineNumberExclusive, t) && is(this.modified.endLineNumberExclusive, n))
      return new de(new k(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new k(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new de(k.fromPositions(new z(this.original.startLineNumber, 1), ot(new z(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(new z(this.modified.startLineNumber, 1), ot(new z(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new de(k.fromPositions(ot(new z(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), ot(new z(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(ot(new z(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), ot(new z(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function ot(e, t) {
  ...
  if (e.lineNumber > t.length)
    return new z(t.length, t[t.length - 1].length + 1);
...
class Ge extends Me {
  static fromRangeMappings(t) {
    const n = G.join(t.map((r) => G.fromRangeInclusive(r.originalRange))), i = G.join(t.map((r) => G.fromRangeInclusive(r.modifiedRange)));
    return new Ge(n, i, t);
  }
  constructor(t, n, i) {
  ...
  flip() {
    return new Ge(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
...
class de {
  static fromEdit(t) {
    ...
    return t.replacements.map((r, s) => new de(r.range, n[s]));
  }
  static fromEditJoin(t) {
    const n = t.getNewRanges(), i = t.replacements.map((r, s) => new de(r.range, n[s]));
    return de.join(i);
  }
  static join(t) {
    if (t.length === 0)
...
function rs(e, t, n, i = !1) {
  const r = [];
  for (const s of d1(e.map((a) => Fl(a, t, n)), (a, u) => a.original.intersectsOrTouches(u.original) || a.modified.intersectsOrTouches(u.modified))) {
  ...
  return Bt(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - r[r.length - 1].original.endLineNumberExclusive) ? !1 : Kn(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), r;
}
function Fl(e, t, n) {
  let i = 0, r = 0;
...
class Il {
  computeDiff(t, n, i) {
    ...
    for (const o of s.changes) {
      let c;
      o.originalEndLineNumber === 0 ? c = new G(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : c = new G(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let f;
      o.modifiedEndLineNumber === 0 ? f = new G(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : f = new G(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let h = new Ge(c, f, o.charChanges?.map((_) => new de(new k(
      ...
      u && (u.modified.endLineNumberExclusive === h.modified.startLineNumber || u.original.endLineNumberExclusive === h.original.startLineNumber) && (h = new Ge(
    ...
    return Bt(() => Kn(a, (o, c) => c.original.startLineNumber - o.original.endLineNumberExclusive === c.modified.startLineNumber - o.modified.endLineNumberExclusive && o.original.endLineNumberExclusive < c.original.startLineNumber && o.modified.endLineNumberExclusive < c.modified.startLineNumber)), new sn(a, [], s.quitEarly);
  }
}
function n1(e, t, n, i) {
...
let ss = class {
  ...
  createCharSequence(t, n, i) {
    ...
    let u = 0;
    for (let o = n; o <= i; o++) {
      const c = this.lines[o], f = t ? this._startColumns[o] : 1, h = t ? this._endColumns[o] : c.length + 1;
      for (let _ = f; _ < h; _++)
...
function yl(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, u) < Sl ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Pt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, u) {
    let o, c, f, h, _;
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (o = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (f = r.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (f = r.getStartLineNumber(n.modifiedStart), h = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      ...
      if (L.getElements().length > 0 && d.getElements().length > 0) {
        let b = n1(L, d, s, !0).changes;
        u && (b = yl(b)), _ = [];
        for (let N = 0, T = b.length; N < T; N++)
          _.push(pt.createFromDiffChange(b[N], L, d));
      }
    }
    return new Pt(
      o,
...
class i1 {
  constructor(t, n, i) {
    this.shouldComputeCharChanges = i.shouldComputeCharChanges, this.shouldPostProcessCharChanges = i.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = i.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = i.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new ss(t), this.modified = new ss(n), this.continueLineDiff = as(i.maxComputationTime), this.continueCharDiff = as(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = n1(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    ...
    for (let u = -1, o = n.length; u < o; u++) {
      const c = u + 1 < o ? n[u + 1] : null, f = c ? c.originalStart : this.originalLines.length, h = c ? c.modifiedStart : this.modifiedLines.length;
      for (; s < f && a < h; ) {
        const _ = this.originalLines[s], L = this.modifiedLines[a];
        if (_ !== L) {
          {
            let d = Yn(_, 1), b = Yn(L, 1);
            for (; d > 1 && b > 1; ) {
              const N = _.charCodeAt(d - 2), T = L.charCodeAt(b - 2);
              if (N !== T)
                break;
              d--, b--;
            }
          ...
          {
            let d = Qn(_, 1), b = Qn(L, 1);
            const N = _.length + 1, T = L.length + 1;
            for (; d < N && b < T; ) {
              const E = _.charCodeAt(d - 1), A = _.charCodeAt(b - 1);
              if (E !== A)
                break;
              d++, b++;
            }
            (d < N || b < T) && this._pushTrimWhitespaceCharChange(r, s + 1, d, N, a + 1, b, T);
          }
        }
        s++, a++;
      }
      c && (r.push(Pt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += c.originalLength, a += c.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
...
class $e {
  static trivial(t, n) {
    return new $e([new re(H.ofLength(t.length), H.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new $e([new re(H.ofLength(t.length), H.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class re {
  static invert(t, n) {
    const i = [];
    return w1(t, (r, s) => {
      i.push(re.fromOffsetPairs(r ? r.getEndExclusives() : Se.zero, s ? s.getStarts() : new Se(
        n,
  ...
  static fromOffsetPairs(t, n) {
    return new re(new H(t.offset1, n.offset1), new H(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const i of t) {
...
class Ol {
  compute(t, n, i = Gt.instance, r) {
    if (t.length === 0 || n.length === 0)
      return $e.trivial(t, n);
    const s = new Tn(t.length, n.length), a = new Tn(t.length, n.length), u = new Tn(t.length, n.length);
    for (let d = 0; d < t.length; d++)
      for (let b = 0; b < n.length; b++) {
        if (!i.isValid())
          return $e.trivialTimedOut(t, n);
        const N = d === 0 ? 0 : s.get(d - 1, b), T = b === 0 ? 0 : s.get(d, b - 1);
        let E;
        t.getElement(d) === n.getElement(b) ? (d === 0 || b === 0 ? E = 0 : E = s.get(d - 1, b - 1), d > 0 && b > 0 && a.get(d - 1, b - 1) === 3 && (E += u.get(d - 1, b - 1)), E += r ? r(d, b) : 1) : E = -1;
        const A = Math.max(N, T, E);
        if (A === E) {
          const F = d > 0 && b > 0 ? u.get(d - 1, b - 1) : 0;
          u.set(d, b, F + 1), a.set(d, b, 3);
        } else A === N ? (u.set(d, b, 0), a.set(d, b, 1)) : A === T && (u.set(d, b, 0), a.set(d, b, 2));
        s.set(d, b, A);
      }
    const o = [];
    let c = t.length, f = n.length;
    function h(d, b) {
      (d + 1 !== c || b + 1 !== f) && o.push(new re(new H(d + 1, c), new H(b + 1, f))), c = d, f = b;
    }
    let _ = t.length - 1, L = n.length - 1;
    for (; _ >= 0 && L >= 0; )
      a.get(_, L) === 3 ? (h(_, L), _--, L--) : a.get(_, L) === 1 ? _-- : L--;
    return h(-1, -1), o.reverse(), new $e(o, !1);
  }
}
class r1 {
  compute(t, n, i = Gt.instance) {
    if (t.length === 0 || n.length === 0)
      return $e.trivial(t, n);
    const r = t, s = n;
    function a(b, N) {
      for (; b < r.length && N < s.length && r.getElement(b) === s.getElement(N); )
        b++, N++;
      return b;
    }
    let u = 0;
    ...
    o.set(0, a(0, 0));
    const c = new Hl();
    c.set(0, o.get(0) === 0 ? null : new ls(null, 0, 0, o.get(0)));
    let f = 0;
    e: for (; ; ) {
      if (u++, !i.isValid())
        return $e.trivialTimedOut(r, s);
      const b = -Math.min(u, s.length + u % 2), N = Math.min(u, r.length + u % 2);
      for (f = b; f <= N; f += 2) {
        const T = f === N ? -1 : o.get(f + 1), E = f === b ? -1 : o.get(f - 1) + 1, A = Math.min(Math.max(T, E), r.length), F = A - f;
        if (A > r.length || F > s.length)
          continue;
        const D = a(A, F);
        o.set(f, D);
        const B = A === T ? c.get(f + 1) : c.get(f - 1);
        if (c.set(f, D !== A ? new ls(B, A, F, D - A) : B), o.get(f) === r.length && o.get(f) - f === s.length)
          break e;
      }
    }
    let h = c.get(f);
    ...
    for (; ; ) {
      const b = h ? h.x + h.length : 0, N = h ? h.y + h.length : 0;
      if ((b !== L || N !== d) && _.push(new re(new H(b, L), new H(N, d))), !h)
        break;
      L = h.x, d = h.y, h = h.prev;
    }
    return _.reverse(), new $e(_, !1);
  }
}
class ls {
  constructor(t, n, i, r) {
...
class dn {
  ...
  getBoundaryScore(t) {
    const n = cs(t > 0 ? this.elements[t - 1] : -1), i = cs(t < this.elements.length ? this.elements[t] : -1);
    if (n === ie.LineBreakCR && i === ie.LineBreakLF)
      return 0;
    if (n === ie.LineBreakLF)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === ie.WordLower && i === ie.WordUpper && (r += 1)), r += os(n), r += os(i), r;
  }
  translateOffset(t, n = "right") {
    const i = xt(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new z(
  ...
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !ct(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && ct(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && ct(this.elements[i]); )
      i++;
    return new H(n, i);
  }
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !ct(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && ct(this.elements[n - 1]) && !us(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && ct(this.elements[i]) && !us(this.elements[i]); )
      i++;
    return new H(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Nt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = b1(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new H(n, i);
  }
}
function ct(e) {
...
function cs(e) {
  return e === p.LineFeed ? ie.LineBreakLF : e === p.CarriageReturn ? ie.LineBreakCR : Zn(e) ? ie.Space : e >= p.a && e <= p.z ? ie.WordLower : e >= p.A && e <= p.Z ? ie.WordUpper : e >= p.Digit0 && e <= p.Digit9 ? ie.WordNumber : e === -1 ? ie.End : e === p.Comma || e === p.Semicolon ? ie.Separator : ie.Other;
}
function Wl(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: u } = $l(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((f) => !u.has(f)), c = zl(o, i, r, t, n, s);
  return L1(a, c), a = jl(a), a = a.filter((f) => {
    const h = f.original.toOffsetRange().slice(t).map((L) => L.trim());
    return h.join(`
`).length >= 15 && Gl(h, (L) => L.length >= 2) >= 2;
  }), a = Xl(e, a), a;
}
function Gl(e, t) {
  let n = 0;
...
function $l(e, t, n, i) {
  const r = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new qt(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new qt(o.modified, n, o))), u = /* @__PURE__ */ new Set();
  for (const o of s) {
    let c = -1, f;
    for (const h of a) {
    ...
    if (c > 0.9 && f && (a.delete(f), r.push(new Me(o.range, f.range)), u.add(o.source), u.add(f.source)), !i.isValid())
...
function zl(e, t, n, i, r, s) {
  ...
  for (const _ of e)
    for (let L = _.original.startLineNumber; L < _.original.endLineNumberExclusive - 2; L++) {
      ...
      u.add(d, { range: new G(L, L + 3) });
    }
  const o = [];
  e.sort(bt((_) => _.modified.startLineNumber, dt));
  for (const _ of e) {
    let L = [];
    for (let d = _.modified.startLineNumber; d < _.modified.endLineNumberExclusive - 2; d++) {
      const b = `${n[d - 1]}:${n[d + 1 - 1]}:${n[d + 2 - 1]}`, N = new G(d, d + 3), T = [];
      u.forEach(b, ({ range: E }) => {
        for (const F of L)
          if (F.originalLineRange.endLineNumberExclusive + 1 === E.endLineNumberExclusive && F.modifiedLineRange.endLineNumberExclusive + 1 === N.endLineNumberExclusive) {
            F.originalLineRange = new G(
              F.originalLineRange.startLineNumber,
              E.endLineNumberExclusive
            ), F.modifiedLineRange = new G(
  ...
  o.sort(N1(bt((_) => _.modifiedLineRange.length, dt)));
  const c = new Pe(), f = new Pe();
  for (const _ of o) {
    const L = _.modifiedLineRange.startLineNumber - _.originalLineRange.startLineNumber, d = c.subtractFrom(_.modifiedLineRange), b = f.subtractFrom(_.originalLineRange).getWithDelta(L), N = d.getIntersection(b);
    for (const T of N.ranges) {
      if (T.length < 3)
        continue;
      const E = T, A = T.delta(-L);
      a.push(new Me(A, E)), c.addRange(E), f.addRange(A);
    }
  }
  a.sort(bt((_) => _.original.startLineNumber, dt));
  const h = new wn(e);
  for (let _ = 0; _ < a.length; _++) {
    const L = a[_], d = h.findLastMonotonous((B) => B.original.startLineNumber <= L.original.startLineNumber), b = Nt(e, (B) => B.modified.startLineNumber <= L.modified.startLineNumber), N = Math.max(L.original.startLineNumber - d.original.startLineNumber, L.modified.startLineNumber - b.modified.startLineNumber), T = h.findLastMonotonous((B) => B.original.startLineNumber < L.original.endLineNumberExclusive), E = Nt(e, (B) => B.modified.startLineNumber < L.modified.endLineNumberExclusive), A = Math.max(T.original.endLineNumberExclusive - L.original.endLineNumberExclusive, E.modified.endLineNumberExclusive - L.modified.endLineNumberExclusive);
    let F;
    for (F = 0; F < N; F++) {
      const B = L.original.startLineNumber - F - 1, R = L.modified.startLineNumber - F - 1;
      if (B > i.length || R > r.length || c.contains(R) || f.contains(B) || !hs(i[B - 1], r[R - 1], s))
        break;
    }
    F > 0 && (f.addRange(new G(L.original.startLineNumber - F, L.original.startLineNumber)), c.addRange(new G(L.modified.startLineNumber - F, L.modified.startLineNumber)));
    let D;
    for (D = 0; D < A; D++) {
      const B = L.original.endLineNumberExclusive + D, R = L.modified.endLineNumberExclusive + D;
      if (B > i.length || R > r.length || c.contains(R) || f.contains(B) || !hs(i[B - 1], r[R - 1], s))
        break;
    }
    D > 0 && (f.addRange(new G(
      L.original.endLineNumberExclusive,
      L.original.endLineNumberExclusive + D
    )), c.addRange(new G(
      L.modified.endLineNumberExclusive,
      L.modified.endLineNumberExclusive + D
    ))), (F > 0 || D > 0) && (a[_] = new Me(new G(
...
function hs(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new r1().compute(new dn([e], new k(1, 1, 1, e.length), !1), new dn([t], new k(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function jl(e) {
  if (e.length === 0)
    return e;
  e.sort(bt((n) => n.original.startLineNumber, dt));
  const t = [e[0]];
...
function Xl(e, t) {
  const n = new wn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((u) => u.original.startLineNumber < i.original.endLineNumberExclusive) || new Me(new G(1, 1), new G(1, 1)), s = Nt(e, (u) => u.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function fs(e, t, n) {
  let i = n;
  return i = gs(e, t, i), i = gs(e, t, i), i = Yl(e, t, i), i;
}
function gs(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= o && !(e.getElement(u.seq1Range.start - c) !== e.getElement(u.seq1Range.endExclusive - c) || t.getElement(u.seq2Range.start - c) !== t.getElement(u.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === o) {
        i[i.length - 1] = new re(new H(a.seq1Range.start, u.seq1Range.endExclusive - o), new H(a.seq2Range.start, u.seq2Range.endExclusive - o));
        continue;
      }
      u = u.delta(-c);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 0; c < o && !(!e.isStronglyEqual(u.seq1Range.start + c, u.seq1Range.endExclusive + c) || !t.isStronglyEqual(u.seq2Range.start + c, u.seq2Range.endExclusive + c)); c++)
        ;
      if (c === o) {
        i[s + 1] = new re(new H(u.seq1Range.start + o, a.seq1Range.endExclusive), new H(u.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (u = u.delta(c));
    }
...
function Yl(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, u = new H(
    ...
    s.seq1Range.isEmpty ? n[i] = ms(s, e, t, u, o) : s.seq2Range.isEmpty && (n[i] = ms(s.swap(), t, e, o, u).swap());
  }
  return n;
}
function ms(e, t, n, i, r) {
  ...
  let o = 0, c = -1;
  for (let f = -a; f <= u; f++) {
    const h = e.seq2Range.start + f, _ = e.seq2Range.endExclusive + f, L = e.seq1Range.start + f, d = t.getBoundaryScore(L) + n.getBoundaryScore(h) + n.getBoundaryScore(_);
    d > c && (c = d, o = f);
  }
  return e.delta(o);
}
...
function _s(e, t, n, i, r = !1) {
  const s = re.invert(n, e.length), a = [];
  let u = new Se(0, 0);
  function o(f, h) {
    if (f.offset1 < u.offset1 || f.offset2 < u.offset2)
      return;
    const _ = i(e, f.offset1), L = i(t, f.offset2);
    if (!_ || !L)
      return;
    let d = new re(_, L);
    const b = d.intersect(h);
    let N = b.seq1Range.length, T = b.seq2Range.length;
    for (; s.length > 0; ) {
      const E = s[0];
      if (!(E.seq1Range.intersects(d.seq1Range) || E.seq2Range.intersects(d.seq2Range)))
        break;
      const F = i(e, E.seq1Range.start), D = i(t, E.seq2Range.start), B = new re(F, D), R = B.intersect(E);
      if (N += R.seq1Range.length, T += R.seq2Range.length, d = d.join(B), d.seq1Range.endExclusive >= E.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    (r && N + T < d.seq1Range.length + d.seq2Range.length || N + T < (d.seq1Range.length + d.seq2Range.length) * 2 / 3) && a.push(d), u = d.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const f = s.shift();
    f.seq1Range.isEmpty || (o(f.getStarts(), f), o(f.getEndExclusives().delta(-1), f));
  }
  return Zl(n, a);
}
function Zl(e, t) {
...
function Jl(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let f = function(_, L) {
        const d = new H(c.seq1Range.endExclusive, o.seq1Range.start);
      ...
      f(c, o) ? (s = !0, a[a.length - 1] = a[a.length - 1].join(o)) : a.push(o);
    }
    i = a;
  } while (r++ < 10 && s);
  return i;
...
function Kl(e, t, n) {
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let h = function(L, d) {
        const b = new H(f.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(b) > 5 || b.length > 500)
          return !1;
        const T = e.getText(b).trim();
        if (T.length > 20 || T.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const E = e.countLinesIn(L.seq1Range), A = L.seq1Range.length, F = t.countLinesIn(L.seq2Range), D = L.seq2Range.length, B = e.countLinesIn(d.seq1Range), R = d.seq1Range.length, v = t.countLinesIn(d.seq2Range), P = d.seq2Range.length, Q = 2 * 40 + 50;
        function Y($) {
          return Math.min($, Q);
        }
        return Math.pow(Math.pow(Y(E * 40 + A), 1.5) + Math.pow(Y(F * 40 + D), 1.5), 1.5) + Math.pow(Math.pow(Y(B * 40 + R), 1.5) + Math.pow(Y(v * 40 + P), 1.5), 1.5) > (Q ** 1.5) ** 1.5 * 1.3;
      };
      const c = i[o], f = u[u.length - 1];
      h(f, c) ? (s = !0, u[u.length - 1] = u[u.length - 1].join(c)) : u.push(c);
    }
    i = u;
  } while (r++ < 10 && s);
  const a = [];
  return p1(i, (u, o, c) => {
    ...
    const _ = e.extendToFullLines(o.seq1Range), L = e.getText(new H(_.start, o.seq1Range.start));
    h(L) && (f = f.deltaStart(-L.length));
    const d = e.getText(new H(o.seq1Range.endExclusive, _.endExclusive));
    h(d) && (f = f.deltaEnd(d.length));
    const b = re.fromOffsetPairs(u ? u.getEndExclusives() : Se.zero, c ? c.getStarts() : Se.max), N = f.intersect(b);
...
class bs {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ds(this.lines[t - 1]), i = t === this.lines.length ? 0 : ds(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class Cl {
  constructor() {
    this.dynamicProgrammingDiffing = new Ol(), this.myersDiffingAlgorithm = new r1();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Ms(t, n, (D, B) => D === B))
      return new sn([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new sn([
        new Ge(new G(1, t.length + 1), new G(1, n.length + 1), [
          new de(new k(
            1,
            1,
            t.length,
    ...
    const r = i.maxComputationTimeMs === 0 ? Gt.instance : new Bl(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function u(D) {
      let B = a.get(D);
      return B === void 0 && (B = a.size, a.set(D, B)), B;
    }
    const o = t.map((D) => u(D.trim())), c = n.map((D) => u(D.trim())), f = new bs(o, t), h = new bs(c, n), _ = f.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(f, h, r, (D, B) => t[D] === n[B] ? n[B].length === 0 ? 0.1 : 1 + Math.log(1 + n[B].length) : 0.99) : this.myersDiffingAlgorithm.compute(f, h, r);
    let L = _.diffs, d = _.hitTimeout;
    L = fs(f, h, L), L = Jl(f, h, L);
    const b = [], N = (D) => {
      if (s)
        for (let B = 0; B < D; B++) {
          const R = T + B, v = E + B;
          if (t[R] !== n[v]) {
            const P = this.refineDiff(t, n, new re(new H(R, R + 1), new H(v, v + 1)), r, s, i);
            for (const Q of P.mappings)
              b.push(Q);
            P.hitTimeout && (d = !0);
          }
        }
    ...
    let T = 0, E = 0;
    for (const D of L) {
      Bt(() => D.seq1Range.start - T === D.seq2Range.start - E);
      const B = D.seq1Range.start - T;
      N(B), T = D.seq1Range.endExclusive, E = D.seq2Range.endExclusive;
      const R = this.refineDiff(t, n, D, r, s, i);
      R.hitTimeout && (d = !0);
      for (const v of R.mappings)
        b.push(v);
    }
    N(t.length - T);
    const A = rs(b, new Qt(t), new Qt(n));
    let F = [];
    return i.computeMoves && (F = this.computeMoves(A, t, n, o, c, r, s, i)), Bt(() => {
      function D(R, v) {
        if (R.lineNumber < 1 || R.lineNumber > v.length)
          return !1;
        const P = v[R.lineNumber - 1];
        return !(R.column < 1 || R.column > P.length + 1);
      }
      function B(R, v) {
        return !(R.startLineNumber < 1 || R.startLineNumber > v.length + 1 || R.endLineNumberExclusive < 1 || R.endLineNumberExclusive > v.length + 1);
      }
      for (const R of A) {
        if (!R.innerChanges)
          return !1;
        for (const v of R.innerChanges)
          if (!(D(v.modifiedRange.getStartPosition(), n) && D(v.modifiedRange.getEndPosition(), n) && D(v.originalRange.getStartPosition(), t) && D(v.originalRange.getEndPosition(), t)))
            return !1;
        if (!B(R.modified, n) || !B(R.original, t))
          return !1;
      }
      return !0;
    }), new sn(A, F, d);
  ...
  computeMoves(t, n, i, r, s, a, u, o) {
    return Wl(t, n, i, r, s, a).map((h) => {
      const _ = this.refineDiff(n, i, new re(h.original.toOffsetRange(), h.modified.toOffsetRange()), a, u, o), L = rs(_.mappings, new Qt(n), new Qt(i), !0);
      return new ai(h, L);
    });
  }
  refineDiff(t, n, i, r, s, a) {
    const o = eu(i).toRangeMapping2(t, n), c = new dn(t, o.originalRange, s), f = new dn(n, o.modifiedRange, s), h = c.length + f.length < 500 ? this.dynamicProgrammingDiffing.compute(c, f, r) : this.myersDiffingAlgorithm.compute(c, f, r);
    let _ = h.diffs;
    return _ = fs(c, f, _), _ = _s(c, f, _, (d, b) => d.findWordContaining(b)), a.extendToSubwords && (_ = _s(c, f, _, (d, b) => d.findSubWordContaining(b), !0)), _ = Ql(c, f, _), _ = Kl(c, f, _), {
      mappings: _.map((d) => new de(c.translateRange(d.seq1Range), f.translateRange(d.seq2Range))),
      hitTimeout: h.hitTimeout
    };
  }
}
function eu(e) {
  return new Me(new G(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new G(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Un = {
  getLegacy: () => new Il(),
  getDefault: () => new Cl()
...
class w {
  constructor(t, n, i, r = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, i)) | 0, this.a = et(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
...
class Ue {
  constructor(t, n, i, r) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = et(Math.max(Math.min(1, n), 0), 3), this.l = et(Math.max(Math.min(1, i), 0), 3), this.a = et(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    const f = (u + a) / 2, h = a - u;
    if (h > 0) {
      switch (c = Math.min(f <= 0.5 ? h / (2 * f) : h / (2 - 2 * f), 1), a) {
        case n:
          o = (i - r) / h + (i < r ? 6 : 0);
          break;
        case i:
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      const c = r < 0.5 ? r * (1 + i) : r + i - r * i, f = 2 * r - c;
      a = Ue._hue2rgb(f, c, n + 1 / 3), u = Ue._hue2rgb(f, c, n), o = Ue._hue2rgb(f, c, n - 1 / 3);
    }
...
class mt {
  constructor(t, n, i, r) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = et(Math.max(Math.min(1, n), 0), 3), this.v = et(Math.max(Math.min(1, i), 0), 3), this.a = et(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return u === 0 ? c = 0 : s === n ? c = ((i - r) / u % 6 + 6) % 6 : s === i ? c = (r - n) / u + 2 : c = (n - i) / u + 4, new mt(Math.round(c * 60), o, s, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, u = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [c, f, h] = [0, 0, 0];
    return n < 60 ? (c = a, f = u) : n < 120 ? (c = u, f = a) : n < 180 ? (f = a, h = u) : n < 240 ? (f = u, h = a) : n < 300 ? (c = u, h = a) : n <= 360 && (c = a, h = u), c = Math.round((c + o) * 255), f = Math.round((f + o) * 255), h = Math.round((h + o) * 255), new w(c, f, h, s);
  }
}
class Z {
  static fromHex(t) {
  ...
  equals(t) {
    return !!t && w.equals(this.rgba, t.rgba) && Ue.equals(this.hsla, t.hsla) && mt.equals(this.hsva, t.hsva);
  }
  ...
  reduceRelativeLuminace(t, n) {
    ...
    for (; a < n && (i > 0 || r > 0 || s > 0); )
      i -= Math.max(0, Math.ceil(i * 0.1)), r -= Math.max(0, Math.ceil(r * 0.1)), s -= Math.max(0, Math.ceil(s * 0.1)), a = this.getContrastRatio(new Z(new w(i, r, s)));
    return new Z(new w(i, r, s));
  }
  increaseRelativeLuminace(t, n) {
    let { r: i, g: r, b: s } = t.rgba, a = this.getContrastRatio(t);
    for (; a < n && (i < 255 || r < 255 || s < 255); )
      i = Math.min(255, i + Math.ceil((255 - i) * 0.1)), r = Math.min(255, r + Math.ceil((255 - r) * 0.1)), s = Math.min(255, s + Math.ceil((255 - s) * 0.1)), a = this.getContrastRatio(new Z(new w(i, r, s)));
    return new Z(new w(i, r, s));
  }
  ...
  ensureConstrast(t, n) {
    ...
    if (this.getContrastRatio(t) < n) {
      if (r < i) {
        ...
        if (c < n) {
          const f = this.increaseRelativeLuminace(t, n), h = this.getContrastRatio(f);
          return c > h ? o : f;
        }
        return o;
      }
  ...
  lighten(t) {
    return new Z(new Ue(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new Z(new Ue(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new Z(new w(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
  ...
  static {
    this.white = new Z(new w(255, 255, 255, 1));
  }
  static {
    this.black = new Z(new w(0, 0, 0, 1));
  }
  static {
    this.red = new Z(new w(255, 0, 0, 1));
  }
  static {
    this.blue = new Z(new w(0, 0, 255, 1));
  }
  static {
    this.green = new Z(new w(0, 255, 0, 1));
  }
  static {
    this.cyan = new Z(new w(0, 255, 255, 1));
  }
  static {
    this.lightgrey = new Z(new w(211, 211, 211, 1));
  }
  static {
    this.transparent = new Z(new w(0, 0, 0, 0));
  }
}
(function(e) {
  (function(t) {
    (function(n) {
      ...
      n.formatHex = o;
      function c(b, N = !1) {
        return N && b.rgba.a === 1 ? e.Format.CSS.formatHex(b) : `#${u(b.rgba.r)}${u(b.rgba.g)}${u(b.rgba.b)}${u(Math.round(b.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function f(b) {
      ...
      function h(b) {
        ...
        if (b.startsWith("rgba(")) {
          ...
          const T = parseInt(N.groups?.r ?? "0"), E = parseInt(N.groups?.g ?? "0"), A = parseInt(N.groups?.b ?? "0"), F = parseFloat(N.groups?.a ?? "0");
          return new e(new w(T, E, A, F));
        }
        if (b.startsWith("rgb(")) {
          const N = b.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!N)
            throw new Error("Invalid color format " + b);
          const T = parseInt(N.groups?.r ?? "0"), E = parseInt(N.groups?.g ?? "0"), A = parseInt(N.groups?.b ?? "0");
          return new e(new w(T, E, A));
        }
        return _(b);
      }
      n.parse = h;
      ...
      function L(b) {
        const N = b.length;
        if (N === 0 || b.charCodeAt(0) !== p.Hash)
          return null;
        if (N === 7) {
          const T = 16 * d(b.charCodeAt(1)) + d(b.charCodeAt(2)), E = 16 * d(b.charCodeAt(3)) + d(b.charCodeAt(4)), A = 16 * d(b.charCodeAt(5)) + d(b.charCodeAt(6));
          return new e(new w(T, E, A, 1));
        }
        if (N === 9) {
          const T = 16 * d(b.charCodeAt(1)) + d(b.charCodeAt(2)), E = 16 * d(b.charCodeAt(3)) + d(b.charCodeAt(4)), A = 16 * d(b.charCodeAt(5)) + d(b.charCodeAt(6)), F = 16 * d(b.charCodeAt(7)) + d(b.charCodeAt(8));
          return new e(new w(T, E, A, F / 255));
        }
        if (N === 4) {
          const T = d(b.charCodeAt(1)), E = d(b.charCodeAt(2)), A = d(b.charCodeAt(3));
          return new e(new w(16 * T + T, 16 * E + E, 16 * A + A));
        }
        if (N === 5) {
          const T = d(b.charCodeAt(1)), E = d(b.charCodeAt(2)), A = d(b.charCodeAt(3)), F = d(b.charCodeAt(4));
          return new e(new w(16 * T + T, 16 * E + E, 16 * A + A, (16 * F + F) / 255));
        }
        return null;
      }
      n.parseHex = L;
...
function tu(e, t) {
  if (!e)
    return;
  const n = Z.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function ps(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = s1(r), a = new Z(new Ue(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
...
function nu(e) {
  const t = [], i = Mt(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|\s+(#)([A-Fa-f0-9]{6})\b|\s+(#)([A-Fa-f0-9]{8})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
...
function uu(e, t) {
  const n = [], i = e.getLineCount(), r = pl(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  for (let a = 1; a <= i; a += Ls - su) {
    const u = Math.min(a + Ls - 1, i), o = [];
    for (let h = a; h <= u; h++)
...
`);
    ...
    let f;
    for (; (f = s.exec(c)) !== null; ) {
      const h = c.substring(0, f.index), _ = (h.match(/\n/g) || []).length, L = a + _, d = f[0].split(`
`), b = d.length, N = L + b - 1, T = h.lastIndexOf(`
`) + 1, E = f.index - T + 1, A = d[d.length - 1], F = b === 1 ? E + f[0].length : A.length + 1, D = {
        startLineNumber: L,
        startColumn: E,
        endLineNumber: N,
        endColumn: F
      }, B = (f.groups ?? {}).label ?? "", R = ((f.groups ?? {}).separator ?? "") !== "", v = {
        range: D,
        text: B,
        hasSeparatorLine: R,
        shouldBeInComments: !0
      };
      (v.text || v.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < v.range.startLineNumber) && n.push(v), s.lastIndex = f.index + f[0].length;
    }
  }
  return n;
}
function ou(e) {
  ...
  return e = e.replace(ru, ""), { text: e, hasSeparatorLine: t };
}
function je(e) {
  return e === p.Slash || e === p.Backslash;
}
function a1(e) {
  return e.replace(/[\\/]/g, ne.sep);
}
function cu(e) {
  return e.indexOf("/") === -1 && (e = a1(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e;
}
function Ns(e, t = ne.sep) {
  if (!e)
    return "";
  ...
  if (je(i)) {
    if (je(e.charCodeAt(1)) && !je(e.charCodeAt(2))) {
      ...
      if (a !== s && !je(e.charCodeAt(s + 1))) {
        for (s += 1; s < n; s++)
          if (je(e.charCodeAt(s)))
            return e.slice(0, s + 1).replace(/[\\/]/g, t);
      }
    }
    return t;
  } else if (hu(i) && e.charCodeAt(1) === p.Colon)
...
class gu {
  ...
  setServerRootPath(t, n) {
    this._serverRootPath = ne.join(n ?? "/", _u(t));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return ne.join(this._serverRootPath, fe.vscodeRemoteResource);
  }
  set(t, n, i) {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${fu}=${encodeURIComponent(s)}`), ce.from({
      scheme: Q1 ? this._preferredWebSchema : fe.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
class yt {
  constructor() {
    this.staticBrowserUris = new ht(), this.appResourcePathUrls = /* @__PURE__ */ new Map();
  }
  static {
    this.FALLBACK_AUTHORITY = bu;
  }
  ...
  uriToBrowserUri(t) {
    return t.scheme === fe.vscodeRemote ? mu.rewrite(t) : t.scheme === fe.file && (Y1 || J1 === `${fe.vscodeFileResource}://${yt.FALLBACK_AUTHORITY}`) ? t.with({
  ...
  registerStaticBrowserUri(t, n) {
    return this.staticBrowserUris.set(t, n), Ot(() => {
...
class du {
  ...
  isEqualOrParent(t, n, i = !1) {
    if (t.scheme === n.scheme) {
      if (t.scheme === fe.file)
        return xs(Ve(t), Ve(n), this._ignorePathCasing(t)) && t.query === n.query && (i || t.fragment === n.fragment);
      if (Rs(t.authority, n.authority))
        return xs(t.path, n.path, this._ignorePathCasing(t), "/") && t.query === n.query && (i || t.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(t, ...n) {
  ...
  dirname(t) {
    if (t.path.length === 0)
      return t;
    let n;
    return t.scheme === fe.file ? n = ce.file(il(Ve(t))).path : (n = ne.dirname(t.path), t.authority && n.length && n.charCodeAt(0) !== p.Slash && (console.error(`dirname("${t.toString})) resulted in a relative path`), n = "/")), t.with({
      path: n
    });
  }
  normalizePath(t) {
    if (!t.path.length)
      return t;
    let n;
    return t.scheme === fe.file ? n = ce.file(Ca(Ve(t))).path : n = ne.normalize(t.path), t.with({
      path: n
    });
  }
  relativePath(t, n) {
    ...
    return ne.relative(i, r);
  }
  resolvePath(t, n) {
    if (t.scheme === fe.file) {
      const i = ce.file(tl(Ve(t), n));
      return t.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = cu(n), t.with({
      path: ne.resolve(t.path, n)
    });
  }
  isAbsolutePath(t) {
  ...
  isEqualAuthority(t, n) {
    return t === n || t !== void 0 && n !== void 0 && ua(t, n);
  }
  hasTrailingPathSeparator(t, n = rn) {
    if (t.scheme === fe.file) {
      const i = Ve(t);
      return i.length > Ns(i).length && i[i.length - 1] === n;
    } else {
      const i = t.path;
      return i.length > 1 && i.charCodeAt(i.length - 1) === p.Slash && !/^[a-zA-Z]:(\/$|\\$)/.test(t.fsPath);
    }
  }
  removeTrailingPathSeparator(t, n = rn) {
    return As(t, n) ? t.with({ path: t.path.substr(0, t.path.length - 1) }) : t;
  }
  addTrailingPathSeparator(t, n = rn) {
    let i = !1;
    if (t.scheme === fe.file) {
      const r = Ve(t);
      i = r !== void 0 && r.length === Ns(r).length && r[r.length - 1] === n;
    } else {
      n = "/";
      const r = t.path;
      i = r.length === 1 && r.charCodeAt(r.length - 1) === p.Slash;
    }
    return !i && !As(t, n) ? t.with({ path: t.path + "/" }) : t;
  }
}
const J = new du(() => !1);
J.isEqual.bind(J);
...
const Rs = J.isEqualAuthority.bind(J), As = J.hasTrailingPathSeparator.bind(J);
    ...
    return {
      next: async () => {
        do {
          ...
          await un.toPromise(this._onStateChanged.event);
        } while (!0);
      },
...
class Nu {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const i of n)
      this._acceptDeleteRange(i.range), this._acceptInsertText(new z(i.range.startLineNumber, i.range.startColumn), i.text);
...
const xu = "workerTextModelSync";
class Eu {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(t) {
    t.setChannel(xu, this);
  }
  getModel(t) {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Ru(ce.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Ru extends Nu {
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], s = this.offsetAt(new z(i + 1, 1)), a = r.matchAll(t);
      for (const u of a)
  ...
  getWordAtPosition(t, n) {
    const i = si(t.column, Js(n), this._lines[t.lineNumber - 1], 0);
    return i ? new k(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
...
class _t {
  constructor(t = null) {
    this._foreignModule = t, this._workerTextModelSyncServer = new Eu();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? Tl.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !a ? null : _t.computeDiff(s, a, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? Un.getDefault() : Un.getLegacy(), a = t.getLinesContent(), u = n.getLinesContent(), o = s.computeDiff(a, u, i), c = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function f(h) {
      return h.map(
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    n = n.slice(0).sort((o, c) => {
      ...
      const f = o.range ? 0 : 1, h = c.range ? 0 : 1;
      return f - h;
    });
    let u = 0;
    ...
    n.length = u + 1;
    for (let { range: o, text: c, eol: f } of n) {
      if (typeof f == "number" && (a = f), k.isEmpty(o) && !c)
        continue;
      const h = r.getValueInRange(o);
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), h === c)
        continue;
      if (Math.max(c.length, h.length) > _t._diffLimit) {
        s.push({ range: o, text: c });
        continue;
      }
      const _ = Sa(h, c, i), L = r.offsetAt(k.lift(o).getStartPosition());
      for (const d of _) {
        const b = r.positionAt(L + d.originalStart), N = r.positionAt(L + d.originalStart + d.originalLength), T = {
  ...
  $computeHumanReadableDiff(t, n, i) {
    ...
    n = n.slice(0).sort((u, o) => {
      ...
      const c = u.range ? 0 : 1, f = o.range ? 0 : 1;
      return c - f;
    });
    for (let { range: u, text: o, eol: c } of n) {
      let b = function(T, E) {
        return new z(
          T.lineNumber + E.lineNumber - 1,
          E.lineNumber === 1 ? T.column + E.column - 1 : E.column
        );
      }, N = function(T, E) {
        const A = [];
        for (let F = E.startLineNumber; F <= E.endLineNumber; F++) {
          const D = T[F - 1];
          F === E.startLineNumber && F === E.endLineNumber ? A.push(D.substring(E.startColumn - 1, E.endColumn - 1)) : F === E.startLineNumber ? A.push(D.substring(E.startColumn - 1)) : F === E.endLineNumber ? A.push(D.substring(0, E.endColumn - 1)) : A.push(D);
        }
        return A;
      };
      ...
      if (o = o.replace(/\r\n|\n|\r/g, r.eol), f === o)
        continue;
      if (Math.max(o.length, f.length) > _t._diffLimit) {
        s.push({ range: u, text: o });
        continue;
      }
      const h = f.split(/\r\n|\n|\r/), _ = o.split(/\r\n|\n|\r/), L = Un.getDefault().computeDiff(h, _, i), d = k.lift(u).getStartPosition();
      for (const T of L.changes)
        if (T.innerChanges)
          for (const E of T.innerChanges)
            s.push({
              range: k.fromPositions(b(d, E.originalRange.getStartPosition()), b(d, E.originalRange.getEndPosition())),
              text: N(_, E.modifiedRange).join(r.eol)
            });
        else
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new pn(), a = new RegExp(i, r), u = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const c = this._getModel(o);
      if (c) {
        for (const f of c.words(a))
          if (!(f === n || !isNaN(Number(f))) && (u.add(f), u.size > _t._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    if (!c)
      return null;
    const f = a.getValueInRange(c);
    return ii.INSTANCE.navigateValueSet(n, o, c, f, i);
  }
  $fmr(t, n) {
...
//# sourceMappingURL=editor.worker-BgGuJ4BX.js.map
