...
var $t;
(function(t) {
  t[t.Uri = 1] = "Uri", t[t.Regexp = 2] = "Regexp", t[t.ScmResource = 3] = "ScmResource", t[t.ScmResourceGroup = 4] = "ScmResourceGroup", t[t.ScmProvider = 5] = "ScmProvider", t[t.CommentController = 6] = "CommentController", t[t.CommentThread = 7] = "CommentThread", t[t.CommentThreadInstance = 8] = "CommentThreadInstance", t[t.CommentThreadReply = 9] = "CommentThreadReply", t[t.CommentNode = 10] = "CommentNode", t[t.CommentThreadNode = 11] = "CommentThreadNode", t[t.TimelineActionContext = 12] = "TimelineActionContext", t[t.NotebookCellActionContext = 13] = "NotebookCellActionContext", t[t.NotebookActionContext = 14] = "NotebookActionContext", t[t.TerminalContext = 15] = "TerminalContext", t[t.TestItemContext = 16] = "TestItemContext", t[t.Date = 17] = "Date", t[t.TestMessageMenuArgs = 18] = "TestMessageMenuArgs", t[t.ChatViewContext = 19] = "ChatViewContext", t[t.LanguageModelToolResult = 20] = "LanguageModelToolResult", t[t.LanguageModelTextPart = 21] = "LanguageModelTextPart", t[t.LanguageModelPromptTsxPart = 22] = "LanguageModelPromptTsxPart", t[t.LanguageModelDataPart = 23] = "LanguageModelDataPart";
})($t || ($t = {}));
function Z1() {
...
const J1 = b1() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function gn(t, e) {
  let n;
  ...
  }), J1 && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function L(t, e, ...n) {
  return gn(typeof t == "number" ? C1(t, e) : e, n);
}
function C1(t, e) {
  const n = Z1()?.[t];
  if (typeof n != "string") {
...
const He = "en";
let at = !1, lt = !1, gt = !1, p1 = !1, an = !1, E1 = !1, ft, mt = He, mn = He, ei, Ee;
const Le = globalThis;
let se;
typeof Le.vscode < "u" && typeof Le.vscode.process < "u" ? se = Le.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (se = process);
const ti = typeof se?.versions?.electron == "string", ni = ti && se?.type === "renderer";
if (typeof se == "object") {
  at = se.platform === "win32", lt = se.platform === "darwin", gt = se.platform === "linux", gt && se.env.SNAP && se.env.SNAP_REVISION, se.env.CI || se.env.BUILD_ARTIFACTSTAGINGDIRECTORY, ft = He, mt = He;
  const t = se.env.VSCODE_NLS_CONFIG;
  if (t)
    try {
      const e = JSON.parse(t);
      ft = e.userLocale, mn = e.osLocale, mt = e.resolvedLanguage || He, ei = e.languagePack?.translationsConfigFile;
    } catch {
    }
  p1 = !0;
} else typeof navigator == "object" && !ni ? (Ee = navigator.userAgent, at = Ee.indexOf("Windows") >= 0, lt = Ee.indexOf("Macintosh") >= 0, E1 = (Ee.indexOf("Macintosh") >= 0 || Ee.indexOf("iPad") >= 0 || Ee.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, gt = Ee.indexOf("Linux") >= 0, Ee?.indexOf("Mobi") >= 0, an = !0, mt = b1() || He, ft = navigator.language.toLowerCase(), mn = ft) : console.error("Unable to resolve platform.");
var Qe;
(function(t) {
  t[t.Web = 0] = "Web", t[t.Mac = 1] = "Mac", t[t.Linux = 2] = "Linux", t[t.Windows = 3] = "Windows";
})(Qe || (Qe = {}));
Qe.Web;
lt ? Qe.Mac : at ? Qe.Windows : gt && Qe.Linux;
const Ze = at, ii = lt, si = p1, ri = an, oi = an && typeof Le.importScripts == "function", ai = oi ? Le.origin : void 0, _e = Ee, Ae = mt;
var bn;
(function(t) {
  function e() {
    return Ae;
  ...
  t.value = e;
  function n() {
    return Ae.length === 2 ? Ae === "en" : Ae.length >= 3 ? Ae[0] === "e" && Ae[1] === "n" && Ae[2] === "-" : !1;
  }
...
const li = typeof Le.postMessage == "function" && !Le.importScripts, ui = (() => {
  if (li) {
    const t = [];
    ...
    return (n) => {
      ...
      t.push({
        id: i,
        callback: n
      }), Le.postMessage({ vscodeScheduleAsyncWork: i }, "*");
    };
  }
...
lt || E1 ? rt.Macintosh : at ? rt.Windows : rt.Linux;
const ci = !!(_e && _e.indexOf("Chrome") >= 0);
_e && _e.indexOf("Firefox") >= 0;
!ci && _e && _e.indexOf("Safari") >= 0;
_e && _e.indexOf("Edg/") >= 0;
...
if (typeof Bt < "u" && typeof Bt.process < "u") {
  ...
  get platform() {
    return Ze ? "win32" : ii ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
const wt = Pe.cwd, qt = Pe.env, di = Pe.platform;
Pe.arch;
const fi = 65, hi = 97, _i = 90, gi = 122, Be = 46, W = 47, te = 92, me = 58, mi = 63;
...
function bi(t, e) {
  if (t === null || typeof t != "object")
    throw new v1(e, "Object", t);
}
function z(t, e) {
  if (typeof t != "string")
    throw new v1(e, "string", t);
}
const he = di === "win32";
function T(t) {
  return t === W || t === te;
...
function yt(t, e, n, i) {
  ...
  for (let c = 0; c <= t.length; ++c) {
    ...
    if (i(u)) {
      if (!(a === c - 1 || l === 1)) if (l === 2) {
        if (s.length < 2 || o !== 2 || s.charCodeAt(s.length - 1) !== Be || s.charCodeAt(s.length - 2) !== Be) {
          if (s.length > 2) {
            const h = s.lastIndexOf(n);
            h === -1 ? (s = "", o = 0) : (s = s.slice(0, h), o = s.length - 1 - s.lastIndexOf(n)), a = c, l = 0;
            continue;
          } else if (s.length !== 0) {
            s = "", o = 0, a = c, l = 0;
            continue;
...
function x1(t, e) {
  bi(e, "pathObject");
  const n = e.dir || e.root, i = e.base || `${e.name || ""}${pi(e.ext)}`;
...
const K = {
  resolve(...t) {
    ...
    for (let s = t.length - 1; s >= -1; s--) {
      let o;
      if (s >= 0) {
        if (o = t[s], z(o, `paths[${s}]`), o.length === 0)
          continue;
      } else e.length === 0 ? o = wt() : (o = qt[`=${e}`] || wt(), (o === void 0 || o.slice(0, 2).toLowerCase() !== e.toLowerCase() && o.charCodeAt(2) === te) && (o = `${e}\\`));
      const a = o.length;
      let l = 0, u = "", c = !1;
      ...
      if (a === 1)
        ...
        if (c = !0, T(o.charCodeAt(1))) {
          ...
          if (f < a && f !== p) {
            const U = o.slice(p, f);
            for (p = f; f < a && T(o.charCodeAt(f)); )
              f++;
            if (f < a && f !== p) {
              for (p = f; f < a && !T(o.charCodeAt(f)); )
                f++;
              (f === a || f !== p) && (u = `\\\\${U}\\${o.slice(p, f)}`, l = f);
            }
          }
        } else
          l = 1;
      else be(h) && o.charCodeAt(1) === me && (u = o.slice(0, 2), l = 2, a > 2 && T(o.charCodeAt(2)) && (c = !0, l = 3));
      if (u.length > 0)
        if (e.length > 0) {
  ...
  normalize(t) {
    ...
    if (T(o))
      if (s = !0, T(t.charCodeAt(1))) {
        ...
        n = 1;
    else be(o) && t.charCodeAt(1) === me && (i = t.slice(0, 2), n = 2, e > 2 && T(t.charCodeAt(2)) && (s = !0, n = 3));
    let a = n < e ? yt(t.slice(n), !s, "\\", T) : "";
    if (a.length === 0 && !s && (a = "."), a.length > 0 && T(t.charCodeAt(e - 1)) && (a += "\\"), !s && i === void 0 && t.includes(":")) {
      if (a.length >= 2 && be(a.charCodeAt(0)) && a.charCodeAt(1) === me)
        return `.\\${a}`;
      let l = t.indexOf(":");
      do
  ...
  isAbsolute(t) {
    ...
    return T(n) || e > 2 && be(n) && t.charCodeAt(1) === me && T(t.charCodeAt(2));
  },
  join(...t) {
    if (t.length === 0)
      return ".";
  ...
  relative(t, e) {
    if (z(t, "from"), z(e, "to"), t === e)
      return "";
    const n = K.resolve(t), i = K.resolve(e);
    if (n === i || (t = n.toLowerCase(), e = i.toLowerCase(), t === e))
      return "";
    if (n.length !== t.length || i.length !== e.length) {
      const O = n.split("\\"), ee = i.split("\\");
      O[O.length - 1] === "" && O.pop(), ee[ee.length - 1] === "" && ee.pop();
      const J = O.length, ge = ee.length, le = J < ge ? J : ge;
      let C;
      for (C = 0; C < le && O[C].toLowerCase() === ee[C].toLowerCase(); C++)
        ;
      return C === 0 ? i : C === le ? ge > le ? ee.slice(C).join("\\") : J > le ? "..\\".repeat(J - 1 - C) + ".." : "" : "..\\".repeat(J - C) + ee.slice(C).join("\\");
    }
    let s = 0;
    for (; s < t.length && t.charCodeAt(s) === te; )
      s++;
    let o = t.length;
    for (; o - 1 > s && t.charCodeAt(o - 1) === te; )
      o--;
    const a = o - s;
    let l = 0;
    for (; l < e.length && e.charCodeAt(l) === te; )
      l++;
    let u = e.length;
    for (; u - 1 > l && e.charCodeAt(u - 1) === te; )
      u--;
    const c = u - l, h = a < c ? a : c;
    let f = -1, p = 0;
    for (; p < h; p++) {
      const O = t.charCodeAt(s + p);
      if (O !== e.charCodeAt(l + p))
        break;
      O === te && (f = p);
    }
    if (p !== h) {
      ...
      if (c > h) {
        if (e.charCodeAt(l + p) === te)
          return i.slice(l + p + 1);
        if (p === 2)
          return i.slice(l + p);
      }
      a > h && (t.charCodeAt(s + p) === te ? f = p : p === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let U = "";
    for (p = s + f + 1; p <= o; ++p)
      (p === o || t.charCodeAt(p) === te) && (U += U.length === 0 ? ".." : "\\..");
    return l += f, U.length > 0 ? `${U}${i.slice(l, u)}` : (i.charCodeAt(l) === te && ++l, i.slice(l, u));
  },
  toNamespacedPath(t) {
    ...
    } else if (be(e.charCodeAt(0)) && e.charCodeAt(1) === me && e.charCodeAt(2) === te)
      return `\\\\?\\${e}`;
    return e;
  },
  dirname(t) {
    ...
    } else be(s) && t.charCodeAt(1) === me && (n = e > 2 && T(t.charCodeAt(2)) ? 3 : 2, i = n);
    let o = -1, a = !0;
    for (let l = e - 1; l >= i; --l)
      if (T(t.charCodeAt(l))) {
        if (!a) {
  ...
  basename(t, e) {
    ...
    let n = 0, i = -1, s = !0, o;
    if (t.length >= 2 && be(t.charCodeAt(0)) && t.charCodeAt(1) === me && (n = 2), e !== void 0 && e.length > 0 && e.length <= t.length) {
      if (e === t)
        return "";
  ...
  extname(t) {
    ...
    t.length >= 2 && t.charCodeAt(1) === me && be(t.charCodeAt(0)) && (e = i = 2);
    for (let l = t.length - 1; l >= e; --l) {
      ...
      s === -1 && (o = !1, s = l + 1), u === Be ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(t) {
    ...
    } else if (be(s) && t.charCodeAt(1) === me) {
      if (n <= 2)
    ...
    let o = -1, a = i, l = -1, u = !0, c = t.length - 1, h = 0;
    for (; c >= i; --c) {
      ...
      l === -1 && (u = !1, l = c + 1), s === Be ? o === -1 ? o = c : h !== 1 && (h = 1) : o !== -1 && (h = -1);
    }
    return l !== -1 && (o === -1 || h === 0 || h === 1 && o === l - 1 && o === a + 1 ? e.base = e.name = t.slice(a, l) : (e.name = t.slice(a, o), e.base = t.slice(a, l), e.ext = t.slice(o, l))), a > 0 && a !== i ? e.dir = t.slice(0, a - 1) : e.dir = e.root, e;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...t) {
    ...
    for (let i = t.length - 1; i >= 0 && !n; i--) {
      const s = t[i];
      z(s, `paths[${i}]`), s.length !== 0 && (e = `${s}/${e}`, n = s.charCodeAt(0) === W);
    }
    if (!n) {
      const i = Ei();
      e = `${i}/${e}`, n = i.charCodeAt(0) === W;
    }
    return e = yt(e, !n, "/", Wt), n ? `/${e}` : e.length > 0 ? e : ".";
  },
  normalize(t) {
    if (z(t, "path"), t.length === 0)
      return ".";
    const e = t.charCodeAt(0) === W, n = t.charCodeAt(t.length - 1) === W;
    return t = yt(t, !e, "/", Wt), t.length === 0 ? e ? "/" : n ? "./" : "." : (n && (t += "/"), e ? `/${t}` : t);
  },
  isAbsolute(t) {
    return z(t, "path"), t.length > 0 && t.charCodeAt(0) === W;
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    return e.length === 0 ? "." : F.normalize(e.join("/"));
  },
  relative(t, e) {
    if (z(t, "from"), z(e, "to"), t === e || (t = F.resolve(t), e = F.resolve(e), t === e))
      return "";
    ...
    if (c === l)
      if (a > l) {
        if (e.charCodeAt(o + c) === W)
          return e.slice(o + c + 1);
        if (c === 0)
          return e.slice(o + c);
      } else s > l && (t.charCodeAt(n + c) === W ? u = c : c === 0 && (u = 0));
    let h = "";
    for (c = n + u + 1; c <= i; ++c)
      (c === i || t.charCodeAt(c) === W) && (h += h.length === 0 ? ".." : "/..");
  ...
  parse(t) {
    ...
    for (; u >= i; --u) {
      ...
      a === -1 && (l = !1, a = u + 1), h === Be ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (a !== -1) {
      const h = o === 0 && n ? 1 : o;
      s === -1 || c === 0 || c === 1 && s === a - 1 && s === o + 1 ? e.base = e.name = t.slice(h, a) : (e.name = t.slice(h, s), e.base = t.slice(h, a), e.ext = t.slice(s, a));
    }
...
F.win32 = K.win32 = K;
F.posix = K.posix = F;
const vi = he ? K.normalize : F.normalize;
he ? K.isAbsolute : F.isAbsolute;
const xi = he ? K.join : F.join, Li = he ? K.resolve : F.resolve, wi = he ? K.relative : F.relative, yi = he ? K.dirname : F.dirname;
he ? K.basename : F.basename;
he ? K.extname : F.extname;
he ? K.parse : F.parse;
const bt = he ? K.sep : F.sep, Ai = /^\w[\w\d+.-]*$/, Ti = /^\//, Ni = /^\/\//;
function Si(t, e) {
  if (!t.scheme && e)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${t.authority}", path: "${t.path}", query: "${t.query}", fragment: "${t.fragment}"}`
    );
  if (t.scheme && !Ai.test(t.scheme))
...
class j {
  static isUri(e) {
    return e instanceof j ? !0 : !e || typeof e != "object" ? !1 : typeof e.authority == "string" && typeof e.fragment == "string" && typeof e.path == "string" && typeof e.query == "string" && typeof e.scheme == "string" && typeof e.fsPath == "string" && typeof e.with == "function" && typeof e.toString == "function";
  }
  constructor(e, n, i, s, o, a = !1) {
    typeof e == "object" ? (this.scheme = e.scheme || D, this.authority = e.authority || D, this.path = e.path || D, this.query = e.query || D, this.fragment = e.fragment || D) : (this.scheme = Ri(e, a), this.authority = n || D, this.path = ki(this.scheme, i || D), this.query = s || D, this.fragment = o || D, Si(this, a));
  }
  get fsPath() {
    return At(this, !1);
  }
  with(e) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = D), i === void 0 ? i = this.authority : i === null && (i = D), s === void 0 ? s = this.path : s === null && (s = D), o === void 0 ? o = this.query : o === null && (o = D), a === void 0 ? a = this.fragment : a === null && (a = D), n === this.scheme && i === this.authority && s === this.path && o === this.query && a === this.fragment ? this : new Ge(n, i, s, o, a);
  }
  static parse(e, n = !1) {
    const i = Oi.exec(e);
    return i ? new Ge(
  ...
  static joinPath(e, ...n) {
    ...
    let i;
    return Ze && e.scheme === "file" ? i = j.file(K.join(At(e, !0), ...n)).path : i = F.join(e.path, ...n), e.with({ path: i });
  }
  toString(e = !1) {
    return Ht(this, e);
  }
  ...
  static revive(e) {
    if (e) {
      ...
      {
        const n = new Ge(e);
        return n._formatted = e.external ?? null, n._fsPath = e._sep === L1 ? e.fsPath ?? null : null, n;
      }
    } else return e;
  }
...
const L1 = Ze ? 1 : void 0;
class Ge extends j {
  constructor() {
    super(...arguments), this._formatted = null, this._fsPath = null;
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = At(this, !1)), this._fsPath;
  }
  toString(e = !1) {
    return e ? Ht(this, !0) : (this._formatted || (this._formatted = Ht(this, !1)), this._formatted);
  }
  toJSON() {
    const e = {
      $mid: $t.Uri
    };
    return this._fsPath && (e.fsPath = this._fsPath, e._sep = L1), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
  }
}
const w1 = {
  [m.Colon]: "%3A",
...
function Ui(t) {
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    i === m.Hash || i === m.QuestionMark ? (e === void 0 && (e = t.substr(0, n)), e += w1[i]) : e !== void 0 && (e += t[n]);
  }
  return e !== void 0 ? e : t;
}
function At(t, e) {
...
function Ht(t, e) {
  ...
  if (s && (i += s, i += ":"), (o || s === "file") && (i += ce, i += ce), o) {
    ...
    if (c !== -1) {
      ...
      o = o.substr(c + 1), c = h.lastIndexOf(":"), c === -1 ? i += n(h, !1, !1) : (i += n(h.substr(0, c), !1, !1), i += ":", i += n(h.substr(c + 1), !1, !0)), i += "@";
    }
  ...
  return l && (i += "?", i += n(l, !1, !1)), u && (i += "#", i += e ? u : pn(u, !1, !1)), i;
}
function y1(t) {
  try {
    return decodeURIComponent(t);
  } catch {
    return t.length > 3 ? t.substr(0, 3) + y1(t.substr(3)) : t;
  }
}
const En = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function ht(t) {
  return t.match(En) ? t.replace(En, (e) => y1(e)) : t;
}
function vn(t, e) {
  const n = jt(t, e);
  return n === -1 ? void 0 : t[n];
}
function jt(t, e, n = 0, i = t.length) {
  let s = n, o = i;
  for (; s < o; ) {
...
function xn(t, e, n = 0, i = t.length) {
  let s = n, o = i;
  for (; s < o; ) {
    const a = Math.floor((s + o) / 2);
    e(t[a]) ? o = a : s = a + 1;
...
const A1 = new Ii();
function Tt(t) {
  A1.onUnexpectedError(t);
}
function we(t) {
  Di(t) || A1.onUnexpectedError(t);
}
function Kt(t) {
  if (t instanceof Error) {
    ...
    return {
      ...
      message: n,
      stack: s,
      noTelemetry: Je.isErrorNoTelemetry(t),
      cause: i ? Kt(i) : void 0,
      code: t.code
    };
  }
...
const Yt = "Canceled";
function Di(t) {
  return t instanceof Fi ? !0 : t instanceof Error && t.name === Yt && t.message === Yt;
}
class Fi extends Error {
  constructor() {
    super(Yt), this.name = this.message;
  }
}
class pt extends Error {
  ...
  static is(e) {
    return e instanceof pt || e instanceof Error && e.name === pt._name;
  }
  constructor(e) {
    super(e), this.name = pt._name;
  }
}
...
class Et {
  ...
  filter(e) {
    return new Et((n) => this.iterate((i) => e(i) ? n(i) : !0));
  }
  map(e) {
    return new Et((n) => this.iterate((i) => n(e(i))));
  }
  some(e) {
    let n = !1;
  ...
  findLastMaxBy(e) {
    let n, i = !0;
    return this.iterate((s) => ((i || Xt.isGreaterThan(e(s, n))) && (i = !1, n = s), !0)), n;
  }
}
function Mi(t, e) {
...
class je {
  ...
  constructor(e, n) {
    if (this[Ln] = "ResourceMap", e instanceof je)
      this.map = new Map(e.map), this.toKey = n ?? je.defaultToKey;
    else if (Bi(e)) {
      this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? je.defaultToKey;
      for (const [i, s] of e)
        this.set(i, s);
    } else
      this.map = /* @__PURE__ */ new Map(), this.toKey = e ?? je.defaultToKey;
  }
  set(e, n) {
    return this.map.set(this.toKey(e), new Pi(e, n)), this;
  }
  get(e) {
  ...
  *[(Ln = Symbol.toStringTag, Symbol.iterator)]() {
...
class k1 {
  ...
  getDisposableData(e) {
    ...
    return n || (n = { parent: null, source: null, isSingleton: !1, value: e, idx: k1.idx++ }, this.livingDisposables.set(e, n)), n;
  }
  trackDisposable(e) {
  ...
  getRootParent(e, n) {
    ...
    if (i)
      return i;
    const s = e.parent ? this.getRootParent(this.getDisposableData(e.parent), n) : e;
    return n.set(e, s), s;
  }
  ...
  computeLeakingDisposables(e = 10, n) {
    ...
    function s(u) {
      function c(f, p) {
        for (; f.length > 0 && p.some(
          (U) => typeof U == "string" ? U === f[0] : f[0].match(U)
        ); )
          f.shift();
      }
...
`).map((f) => f.trim().replace("at ", "")).filter((f) => f !== "");
    ...
    for (const u of i) {
      ...
      for (let h = 0; h <= c.length; h++)
        o.add(c.slice(0, h).join(`
`), u);
    }
    i.sort(N1((u) => u.idx, S1));
    let a = "", l = 0;
    for (const u of i.slice(0, e)) {
      l++;
      const c = s(u), h = [];
      for (let f = 0; f < c.length; f++) {
        let p = c[f];
        p = `(shared with ${o.get(c.slice(0, f + 1).join(`
`)).size}/${i.length} leaks) at ${p}`;
        const O = o.get(c.slice(0, f).join(`
`)), ee = Mi([...O].map((J) => s(J)[f]), (J) => J);
        delete ee[c[f]];
        for (const [J, ge] of Object.entries(ee))
          h.unshift(`    - stacktraces of ${ge.length} other leaks continue with ${J}`);
        h.unshift(p);
      }
      a += `
...
class ye {
  ...
  add(e) {
    ...
    return this._isDisposed ? ye.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
class Ki extends Re {
  constructor(e, n, i, s) {
    super(), this._host = e, this._initialState = i.INITIAL, this._scopeRegistry = new ji(), this._injections = {}, this._injectedEmbeddedLanguages = {}, this._languageToScope = /* @__PURE__ */ new Map(), this._grammarRegistry = this._register(new i.Registry({
      onigLib: s,
      loadGrammar: async (o) => {
  ...
  async createGrammar(e, n) {
    ...
    try {
      ...
      throw u.message && u.message.startsWith("No grammar provided for") ? new Error(zt) : u;
    }
    return {
      languageId: e,
      grammar: l,
...
class vt {
  static {
    this.Undefined = new vt(void 0);
  }
  constructor(e) {
    this.element = e, this.next = vt.Undefined, this.prev = vt.Undefined;
  }
}
const Yi = globalThis.performance.now.bind(globalThis.performance);
class Dt {
  static create(e) {
    return new Dt(e);
  }
  constructor(e) {
    this._now = e === !1 ? Date.now : Yi, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(t) {
  ...
  function n(v) {
    return (_, E = null, b) => {
      ...
      return N = v((k) => {
        if (!y)
          return N ? N.dispose() : y = !0, _.call(E, k);
      }, null, b), y && N.dispose(), N;
    };
  }
  t.once = n;
  function i(v, _) {
    return t.once(t.filter(v, _));
  }
  t.onceIf = i;
  function s(v, _, E) {
    return h((b, y = null, N) => v((k) => b.call(y, _(k)), null, N), E);
  }
  t.map = s;
  function o(v, _, E) {
    return h((b, y = null, N) => v((k) => {
      _(k), b.call(y, k);
    }, null, N), E);
  }
  t.forEach = o;
  function a(v, _, E) {
    return h((b, y = null, N) => v((k) => _(k) && b.call(y, k), null, N), E);
  }
  t.filter = a;
  function l(v) {
    return v;
  ...
  function u(...v) {
    return (_, E = null, b) => {
      const y = Hi(...v.map((N) => N((k) => _.call(E, k))));
      return f(y, b);
    };
  }
  t.any = u;
  ...
  function h(v, _) {
    ...
    return _?.add(y), y.event;
  }
  function f(v, _) {
    return _ instanceof Array ? _.push(v) : _ && _.add(v), v;
  }
  function p(v, _, E = 100, b = !1, y = !1, N, k) {
    let q, Q, Oe, ct = 0, Ce;
    const Y1 = {
      leakWarningThreshold: N,
      onWillAddFirstListener() {
        q = v((X1) => {
          ct++, Q = _(Q, X1), b && !Oe && (dt.fire(Q), Q = void 0), Ce = () => {
            const Q1 = Q;
            Q = void 0, Oe = void 0, (!b || ct > 1) && dt.fire(Q1), ct = 0;
          }, typeof E == "number" ? (Oe && clearTimeout(Oe), Oe = setTimeout(Ce, E)) : Oe === void 0 && (Oe = null, queueMicrotask(Ce));
        });
      },
    ...
    return k?.add(dt), dt.event;
  }
  t.debounce = p;
  function U(v, _ = 0, E) {
    return t.debounce(v, (b, y) => b ? (b.push(y), b) : [y], _, void 0, !0, void 0, E);
  }
  t.accumulate = U;
  function O(v, _ = (b, y) => b === y, E) {
    let b = !0, y;
    return a(v, (N) => {
      const k = b || !_(N, y);
      return b = !1, y = N, k;
  ...
  class C {
    ...
    forEach(_) {
      return this.steps.push((E) => (_(E), E)), this;
    }
    filter(_) {
      return this.steps.push((E) => _(E) ? E : le), this;
    }
    reduce(_, E) {
      let b = E;
      return this.steps.push((y) => (b = _(b, y), b)), this;
    }
    latch(_ = (E, b) => E === b) {
      let E = !0, b;
      return this.steps.push((y) => {
        const N = E || !_(y, b);
        return E = !1, b = y, N ? y : le;
      }), this;
    }
    evaluate(_) {
  ...
  function Ft(v, _, E = (b) => b) {
    const b = (...q) => k.fire(E(...q)), y = () => v.on(_, b), N = () => v.removeListener(_, b), k = new ae(
      { onWillAddFirstListener: y, onDidRemoveLastListener: N }
    );
    return k.event;
  }
  t.fromNodeEventEmitter = Ft;
  function Mt(v, _, E = (b) => b) {
    const b = (...q) => k.fire(E(...q)), y = () => v.addEventListener(_, b), N = () => v.removeEventListener(_, b), k = new ae(
      { onWillAddFirstListener: y, onDidRemoveLastListener: N }
    );
    return k.event;
  }
  t.fromDOMEventEmitter = Mt;
  function Pt(v, _) {
    let E;
    const b = new Promise((y, N) => {
      const k = n(v)(y, null, _);
      E = () => k.dispose();
    });
    return b.cancel = E, b;
  }
  ...
  class X {
    constructor(_, E) {
      ...
      this.emitter = new ae(b), E && E.add(this.emitter);
    }
    beginUpdate(_) {
      this._counter++;
    }
  ...
  function ut(v) {
    return (_, E, b) => {
      ...
      const k = {
        ...
        endUpdate() {
          y--, y === 0 && (v.reportChanges(), N && (N = !1, _.call(E)));
        },
      ...
      v.addObserver(k), v.reportChanges();
      const q = {
        dispose() {
          v.removeObserver(k);
        }
      };
      return b instanceof ye ? b.add(q) : Array.isArray(b) && b.push(q), q;
    };
  }
  t.fromObservableLight = ut;
})(Nt || (Nt = {}));
class St {
  static {
  ...
  constructor(e) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${e}_${St._idPool++}`, St.all.add(this);
  }
  start(e) {
...
class ln {
  ...
  constructor(e, n, i = (ln._idPool++).toString(16).padStart(3, "0")) {
...
class Vt {
  constructor(e) {
    this.value = e, this.id = Ji++;
  }
}
const Ci = 2;
class ae {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new ln(
      e?.onListenerError ?? we,
      this._options?.leakWarningThreshold ?? Xi
    ) : void 0, this._perfMon = this._options?._profName ? new St(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (e, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new Zi(
          `${l}. HINT: Stack shows most frequent listener (${u[1]}-times)`,
          u[0]
        );
        return (this._options?.onListenerError || we)(c), Re.None;
      }
      if (this._disposed)
        return Re.None;
      n && (e = e.bind(n));
      const s = new Vt(e);
      let o;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = un.create(), o = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof Vt ? (this._deliveryQueue ??= new es(), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = ze(() => {
        o?.(), this._removeListener(s);
      });
      return i instanceof ye ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }, this._event;
  }
  _removeListener(e) {
  ...
  _deliver(e, n) {
    if (!e)
      return;
    const i = this._options?.onListenerError || we;
    if (!i) {
      e.value(n);
      return;
    }
  ...
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Vt)
...
const U1 = Object.freeze(function(t, e) {
...
(function(t) {
  function e(n) {
    return n === t.None || n === t.Cancelled || n instanceof ts ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class ts {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? U1 : (this._emitter || (this._emitter = new ae()), this._emitter.event);
  }
  dispose() {
...
class is {
  constructor(e, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = ns) : (this._fn = n, this._computeKey = e.getCacheKey);
  }
  get(e) {
...
function os(t, e, n = 0, i = t.length, s = 0, o = e.length) {
  for (; n < i && s < o; n++, s++) {
...
function I1(t, e, n = 0, i = t.length, s = 0, o = e.length) {
  for (; n < i && s < o; n++, s++) {
    let u = t.charCodeAt(n), c = e.charCodeAt(s);
    if (u === c)
      continue;
    if (u >= 128 || c >= 128)
      return os(t.toLowerCase(), e.toLowerCase(), n, i, s, o);
    Tn(u) && (u -= 32), Tn(c) && (c -= 32);
    const h = u - c;
    if (h !== 0)
      return h;
...
function as(t, e) {
  return t.length === e.length && I1(t, e) === 0;
}
function ls(t, e) {
  const n = e.length;
  return e.length > t.length ? !1 : I1(t, e, 0, n) === 0;
}
...
class nt {
  ...
  getGraphemeBreakType(e) {
    if (e < 32)
      return e === m.LineFeed ? Fe.LF : e === m.CarriageReturn ? Fe.CR : Fe.Control;
    if (e < 127)
      return Fe.Other;
...
class it {
  ...
  static {
    this.cache = new is({ getCacheKey: JSON.stringify }, (e) => {
      ...
      let a = e.filter((h) => !h.startsWith("_") && h in o);
  ...
  static getInstance(e) {
    return it.cache.get(Array.from(e));
  }
  static {
    this._locales = new An(() => Object.keys(it.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
  }
  static getLocales() {
...
class st {
  ...
  static isInvisibleCharacter(e) {
    return st.getData().has(e);
  }
  static containsInvisibleCharacter(e) {
    for (let n = 0; n < e.length; n++) {
      const i = e.codePointAt(n);
      if (typeof i == "number" && (st.isInvisibleCharacter(i) || i === Zt.space))
        return !0;
    }
    return !1;
  }
...
function F1(t) {
  return t.replace(/[\\/]/g, F.sep);
}
function cs(t) {
  return t.indexOf("/") === -1 && (t = F1(t)), /^[a-zA-Z]:(\/|$)/.test(t) && (t = "/" + t), t;
}
function Nn(t, e = F.sep) {
  if (!t)
    return "";
  const n = t.length, i = t.charCodeAt(0);
  if (Te(i)) {
    if (Te(t.charCodeAt(1)) && !Te(t.charCodeAt(2))) {
      let o = 3;
      const a = o;
      for (; o < n && !Te(t.charCodeAt(o)); o++)
        ;
      if (a !== o && !Te(t.charCodeAt(o + 1))) {
        for (o += 1; o < n; o++)
          if (Te(t.charCodeAt(o)))
            return t.slice(0, o + 1).replace(/[\\/]/g, e);
      }
    }
    return e;
  } else if (ds(i) && t.charCodeAt(1) === m.Colon)
    return Te(t.charCodeAt(2)) ? t.slice(0, 2) + e : t.slice(0, 2);
  let s = t.indexOf("://");
  if (s !== -1) {
    for (s += 3; s < n; s++)
      if (Te(t.charCodeAt(s)))
        return t.slice(0, s + 1);
  }
  return "";
}
function Sn(t, e, n, i = bt) {
  if (t === e)
    return !0;
...
class hs {
  ...
  setServerRootPath(e, n) {
    this._serverRootPath = F.join(n ?? "/", gs(e));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return F.join(this._serverRootPath, Y.vscodeRemoteResource);
  }
  set(e, n, i) {
  ...
  rewrite(e) {
    ...
    return typeof o == "string" && (a += `&${fs}=${encodeURIComponent(o)}`), j.from({
      scheme: ri ? this._preferredWebSchema : Y.vscodeRemoteResource,
      authority: `${i}:${s}`,
...
class ot {
  constructor() {
    this.staticBrowserUris = new je(), this.appResourcePathUrls = /* @__PURE__ */ new Map();
  }
  static {
    this.FALLBACK_AUTHORITY = ms;
  }
  ...
  uriToBrowserUri(e) {
    return e.scheme === Y.vscodeRemote ? _s.rewrite(e) : e.scheme === Y.file && (si || ai === `${Y.vscodeFileResource}://${ot.FALLBACK_AUTHORITY}`) ? e.with({
      scheme: Y.vscodeFileResource,
      authority: e.authority || ot.FALLBACK_AUTHORITY,
      query: null,
      fragment: null
  ...
  uriToFileUri(e) {
    return e.scheme === Y.vscodeFileResource ? e.with({
      scheme: Y.file,
      authority: e.authority !== ot.FALLBACK_AUTHORITY ? e.authority : null,
      query: null,
      fragment: null
    }) : e;
  }
  toUri(e) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(n))
        return j.joinPath(j.parse(n, !0), e);
      const i = xi(n, e);
      return j.file(i);
    }
    return j.parse(this.toUrl(e));
  }
  registerStaticBrowserUri(e, n) {
    return this.staticBrowserUris.set(e, n), ze(() => {
...
(function(t) {
  ...
  function i(o) {
    let a;
    typeof o == "string" ? a = new URL(o).searchParams : o instanceof URL ? a = o.searchParams : j.isUri(o) && (a = new URL(o.toString(!0)).searchParams);
    const l = a?.get(n);
    if (l)
      return e.get(l);
  }
...
class bs {
  ...
  compare(e, n, i = !1) {
    return e === n ? 0 : rs(this.getComparisonKey(e, i), this.getComparisonKey(n, i));
  }
  isEqual(e, n, i = !1) {
  ...
  isEqualOrParent(e, n, i = !1) {
    if (e.scheme === n.scheme) {
      if (e.scheme === Y.file)
        return Sn(pe(e), pe(n), this._ignorePathCasing(e)) && e.query === n.query && (i || e.fragment === n.fragment);
      if (kn(e.authority, n.authority))
        return Sn(e.path, n.path, this._ignorePathCasing(e), "/") && e.query === n.query && (i || e.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(e, ...n) {
    return j.joinPath(e, ...n);
  }
  basenameOrAuthority(e) {
    return ps(e) || e.authority;
  }
  basename(e) {
  ...
  dirname(e) {
    if (e.path.length === 0)
      return e;
    let n;
    return e.scheme === Y.file ? n = j.file(yi(pe(e))).path : (n = F.dirname(e.path), e.authority && n.length && n.charCodeAt(0) !== m.Slash && (console.error(`dirname("${e.toString})) resulted in a relative path`), n = "/")), e.with({
      path: n
    });
  }
  normalizePath(e) {
    if (!e.path.length)
      return e;
    let n;
    return e.scheme === Y.file ? n = j.file(vi(pe(e))).path : n = F.normalize(e.path), e.with({
      path: n
    });
  }
  relativePath(e, n) {
    if (e.scheme !== n.scheme || !kn(e.authority, n.authority))
      return;
    if (e.scheme === Y.file) {
      const o = wi(pe(e), pe(n));
      return Ze ? F1(o) : o;
    }
    let i = e.path || "/";
    const s = n.path || "/";
    ...
    return F.relative(i, s);
  }
  resolvePath(e, n) {
    if (e.scheme === Y.file) {
      const i = j.file(Li(pe(e), n));
      return e.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = cs(n), e.with({
      path: F.resolve(e.path, n)
    });
  }
  isAbsolutePath(e) {
  ...
  isEqualAuthority(e, n) {
    return e === n || e !== void 0 && n !== void 0 && as(e, n);
  }
  hasTrailingPathSeparator(e, n = bt) {
    if (e.scheme === Y.file) {
      const i = pe(e);
      return i.length > Nn(i).length && i[i.length - 1] === n;
    } else {
      const i = e.path;
      return i.length > 1 && i.charCodeAt(i.length - 1) === m.Slash && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath);
    }
  }
  removeTrailingPathSeparator(e, n = bt) {
    return On(e, n) ? e.with({ path: e.path.substr(0, e.path.length - 1) }) : e;
  }
  addTrailingPathSeparator(e, n = bt) {
    let i = !1;
    if (e.scheme === Y.file) {
      const s = pe(e);
      i = s !== void 0 && s.length === Nn(s).length && s[s.length - 1] === n;
    } else {
      n = "/";
      const s = e.path;
      i = s.length === 1 && s.charCodeAt(s.length - 1) === m.Slash;
    }
    return !i && !On(e, n) ? e.with({ path: e.path + "/" }) : e;
  }
}
const R = new bs(() => !1);
R.isEqual.bind(R);
...
const kn = R.isEqualAuthority.bind(R), On = R.hasTrailingPathSeparator.bind(R);
...
class ie {
  ...
  static {
    this.EMPTY = ie.fromArray([]);
  }
  constructor(e, n) {
    this._state = ue.Initial, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new ae(), queueMicrotask(async () => {
      const i = {
    ...
    return {
      next: async () => {
        do {
          ...
          await Nt.toPromise(this._onStateChanged.event);
        } while (!0);
      },
...
let Ie;
function M1(t) {
  Ie ? Ie instanceof Fn ? Ie.loggers.push(t) : Ie = new Fn([Ie, t]) : Ie = t;
}
function G() {
  return Ie;
}
...
class Ls {
  ...
  _run() {
    ...
    this._dependenciesToBeRemoved = this._dependencies, this._dependencies = e, this._state = H.upToDate;
    try {
      if (!this._disposed) {
  ...
  beginUpdate(e) {
    this._state === H.upToDate && (this._state = H.dependenciesMightHaveChanged), this._updateCount++;
  }
  endUpdate(e) {
    try {
      if (this._updateCount === 1)
        do {
          if (this._state === H.dependenciesMightHaveChanged) {
            this._state = H.upToDate;
            for (const n of this._dependencies)
              if (n.reportChanges(), this._state === H.stale)
                break;
          }
          this._state !== H.upToDate && this._run();
        } while (this._state !== H.upToDate);
    } finally {
      this._updateCount--;
    }
    R1(() => this._updateCount >= 0);
  }
  handlePossibleChange(e) {
    this._state === H.upToDate && this._isDependency(e) && (this._state = H.dependenciesMightHaveChanged);
  }
  handleChange(e, n) {
    if (this._isDependency(e)) {
      ...
      try {
        (this._changeTracker ? this._changeTracker.handleChange({
          ...
          change: n,
          didChange: (s) => s === e
        }, this._changeSummary) : !0) && (this._state = H.stale);
      } catch (i) {
        Tt(i);
      }
    }
  ...
  get store() {
    ...
    return this._store === void 0 && (this._store = new ye()), this._store;
  }
  get delayedStore() {
    if (this._ensureNoRunning(), this._disposed)
      throw new $("Cannot access store after dispose");
    return this._delayedStore === void 0 && (this._delayedStore = new ye()), this._delayedStore;
  }
  debugGetState() {
    return {
  ...
  debugRerun() {
    this._isRunning ? this._state = H.stale : this._run();
  }
}
const cn = (t, e) => t === e;
class kt {
...
const Mn = /* @__PURE__ */ new Map(), Ct = /* @__PURE__ */ new WeakMap();
function ws(t, e) {
  const n = Ct.get(t);
  if (n)
    return n;
...
function ys(t, e) {
  ...
  if (a !== void 0 && (s = dn(a), s !== void 0))
    return i + s;
  if (e.owner !== void 0) {
    const l = As(e.owner, t);
    if (l !== void 0)
      return i + l;
  }
}
...
const Pn = /* @__PURE__ */ new Map(), Bn = /* @__PURE__ */ new WeakMap();
function Ts(t) {
  const e = Bn.get(t);
  if (e)
    return e;
...
class ks {
  ...
  recomputeInitiallyAndOnChange(e, n) {
    return e.add(B1(this, n)), this;
  }
  keepObserved(e) {
    return e.add(z1(this)), this;
  }
  get debugValue() {
    return this.get();
  }
...
class fn extends ks {
  ...
  log() {
    const e = !!G();
    return xs(this), e || G()?.handleObservableCreated(this), this;
  }
  debugGetObservers() {
...
class ve extends fn {
  ...
  onLastObserverRemoved() {
    this._state = P.initial, this._value = void 0, G()?.handleDerivedCleared(this);
    for (const e of this._dependencies)
      e.removeObserver(this);
  ...
  get() {
    if (this._observers.size === 0) {
      ...
      do {
        if (this._state === P.dependenciesMightHaveChanged) {
          for (const e of this._dependencies)
            if (e.reportChanges(), this._state === P.stale)
              break;
        }
        this._state === P.dependenciesMightHaveChanged && (this._state = P.upToDate), this._state !== P.upToDate && this._recompute();
      } while (this._state !== P.upToDate);
      return this._value;
    }
  }
  _recompute() {
    ...
    try {
      ...
      const s = this._state !== P.initial, o = this._value;
  ...
  beginUpdate(e) {
    ...
    try {
      ...
      if (this._state === P.upToDate && (this._state = P.dependenciesMightHaveChanged, !n))
        for (const i of this._observers)
  ...
  handlePossibleChange(e) {
    if (this._state === P.upToDate && this._dependencies.has(e) && !this._dependenciesToBeRemoved.has(e)) {
      this._state = P.dependenciesMightHaveChanged;
  ...
  handleChange(e, n) {
    if (this._dependencies.has(e) && !this._dependenciesToBeRemoved.has(e) || this._isInBeforeUpdate) {
      ...
      const s = this._state === P.upToDate;
      if (i && (this._state === P.dependenciesMightHaveChanged || s) && (this._state = P.stale, s))
  ...
  get store() {
    return this._ensureReaderValid(), this._store === void 0 && (this._store = new ye()), this._store;
  }
  get delayedStore() {
    return this._ensureReaderValid(), this._delayedStore === void 0 && (this._delayedStore = new ye()), this._delayedStore;
  }
  addObserver(e) {
...
function Os(t, e) {
  return new ve(new kt(t.owner, t.debugName, t.debugReferenceFn), e, void 0, t.onLastObserverRemoved, t.equalsFn ?? cn);
}
Ns(Os);
function zn(t) {
  const e = new Error("BugIndicatingErrorRecovery: " + t);
  we(e), console.error("recovered from an error that indicates a bug", e);
}
function V1(t, e) {
  const n = new G1(t, e);
  try {
...
class G1 {
  ...
  getDebugName() {
    return this._getDebugName ? this._getDebugName() : dn(this._fn);
  }
  updateObserver(e, n) {
    if (!this._updatingObservers) {
      zn("Transaction already finished!"), V1((i) => {
  ...
  finish() {
    ...
    if (!e) {
      zn("transaction.finish() has already been called!");
      return;
    }
    for (let n = 0; n < e.length; n++) {
...
function Is(t, e) {
  let n;
  return typeof t == "string" ? n = new kt(void 0, t, void 0) : n = new kt(t, void 0, void 0), new tn(n, e, cn);
}
class tn extends fn {
  get debugName() {
...
function Vn(...t) {
  let e, n, i;
  return t.length === 3 ? [e, n, i] = t : [n, i] = t, new Me(new kt(e, void 0, i), n, i, () => Me.globalTransaction, cn);
}
class Me extends fn {
  constructor(e, n, i, s, o) {
    super(), this._debugNameData = e, this.event = n, this._getValue = i, this._getTransaction = s, this._equalityComparator = o, this._hasValue = !1, this.handleEvent = (a) => {
      ...
      let h = !1;
      c && (this._value = l, this._hasValue && (h = !0, Us(this._getTransaction(), (f) => {
        G()?.handleObservableUpdated(this, { oldValue: u, newValue: l, change: void 0, didChange: c, hadValue: this._hasValue });
        for (const p of this._observers)
          f.updateObserver(p, this), p.handleChange(this, void 0);
      }, () => {
        const f = this.getDebugName();
        return "Event fired" + (f ? `: ${f}` : "");
      })), this._hasValue = !0), h || G()?.handleObservableUpdated(this, { oldValue: u, newValue: l, change: void 0, didChange: c, hadValue: this._hasValue });
    };
  }
  getDebugName() {
...
(function(t) {
  ...
  function e(n, i) {
    let s = !1;
    Me.globalTransaction === void 0 && (Me.globalTransaction = n, s = !0);
    try {
      i();
    } finally {
      s && (Me.globalTransaction = void 0);
    }
  }
  t.batchEventsGlobally = e;
})(Vn || (Vn = {}));
function $1(t) {
  const e = new q1(!1, void 0);
  return t.addObserver(e), ze(() => {
    t.removeObserver(e);
  });
}
Rs($1);
...
let _t;
function Fs(t) {
  _t || (_t = new Ms(), M1(_t)), _t.addFilteredObj(t);
}
class Ms {
  constructor() {
  ...
  handleObservableUpdated(e, n) {
    if (this._isIncluded(e)) {
      ...
      console.log(...this.textToConsoleArgs([
        We("observable value changed"),
        re(e.debugName, { color: "BlueViolet" }),
        ...this.formatInfo(n)
      ]));
    }
  }
  formatChanges(e) {
    if (e.size !== 0)
      return re(" (changed deps: " + [...e].map((n) => n.debugName).join(", ") + ")", { color: "gray" });
  }
  handleDerivedDependencyChanged(e, n, i) {
  ...
  handleFromEventObservableTriggered(e, n) {
    this._isIncluded(e) && console.log(...this.textToConsoleArgs([
      We("observable from event triggered"),
      re(e.debugName, { color: "BlueViolet" }),
      ...this.formatInfo(n),
      { data: [{ fn: e._getValue }] }
    ]));
...
function qe(t) {
  return re(t, { color: "black" });
}
function We(t) {
  return re(Gs(`${t}: `, 10), { color: "black", bold: !0 });
}
function re(t, e = {
  color: "black"
}) {
...
function xe(t, e) {
  switch (typeof t) {
    ...
    case "undefined":
      return "undefined";
    case "object":
      return t === null ? "null" : Array.isArray(t) ? Bs(t, e) : zs(t, e);
    case "symbol":
      return t.toString();
    case "function":
...
function W1(t, e) {
  for (const n in e)
    t[n] && typeof t[n] == "object" && e[n] && typeof e[n] == "object" ? W1(t[n], e[n]) : t[n] = e[n];
}
function H1(t, e) {
  for (const n in e)
    e[n] === null ? delete t[n] : t[n] && typeof t[n] == "object" && e[n] && typeof e[n] == "object" ? H1(t[n], e[n]) : t[n] = e[n];
}
class Ke {
  static {
  ...
  _getInfo(e, n) {
    if (e instanceof ve) {
      ...
      if (!s)
        return;
      const o = e.debugGetState(), a = { name: e.debugName, instanceId: s.instanceId, updateCount: o.updateCount }, l = [...s.changedObservables].map((u) => this._instanceInfos.get(u)?.instanceId).filter(et);
      if (o.isComputing)
      ...
      switch (o.state) {
        ...
        case P.dependenciesMightHaveChanged:
      ...
      switch (e.debugGetState().state) {
        ...
        case H.dependenciesMightHaveChanged:
  ...
  constructor() {
    this._declarationId = 0, this._instanceId = 0, this._declarations = /* @__PURE__ */ new Map(), this._instanceInfos = /* @__PURE__ */ new WeakMap(), this._aliveInstances = /* @__PURE__ */ new Map(), this._activeTransactions = /* @__PURE__ */ new Set(), this._channel = $s("observableDevTools", () => ({
      notifications: {
      ...
      requests: {
        ...
        getObservableValueInfo: (e) => ({
          observers: [...this._aliveInstances.get(e).debugGetObservers()].map((i) => this._formatObserver(i)).filter(et)
        }),
        getDerivedInfo: (e) => {
          const n = this._aliveInstances.get(e);
          return {
            dependencies: [...n.debugGetState().dependencies].map((i) => this._formatObservable(i)).filter(et),
            observers: [...n.debugGetObservers()].map((i) => this._formatObserver(i)).filter(et)
          };
        },
        getAutorunInfo: (e) => ({
          dependencies: [...this._aliveInstances.get(e).debugGetState().dependencies].map((i) => this._formatObservable(i)).filter(et)
        }),
        ...
        setValue: (e, n) => {
          ...
          if (i instanceof ve)
            ...
            throw new $("Observable is not supported");
        ...
        getValue: (e) => {
          const n = this._aliveInstances.get(e);
          if (n instanceof ve)
            return xe(n.debugGetState().value, 200);
          if (n instanceof tn)
            return xe(n.debugGetState().value, 200);
        }
      }
    })), this._pendingChanges = null, this._changeThrottler = new Hs(), this._fullState = {}, this._flushUpdates = () => {
      this._pendingChanges !== null && (this._channel.api.notifications.handleChange(this._pendingChanges, !1), this._pendingChanges = null);
    };
  }
  _handleChange(e) {
    H1(this._fullState, e), this._pendingChanges === null ? this._pendingChanges = e : W1(this._pendingChanges, e), this._changeThrottler.throttle(this._flushUpdates, 10);
  }
  _getDeclarationId(e) {
    let n = !0, i;
    const s = Error;
    for (; ; ) {
      ...
      s.stackTraceLimit = a;
      let u = Gn(l, /[/\\]observableInternal[/\\]|\.observe|[/\\]util(s)?\./);
      if (!n && !u && (u = Gn(l, /[/\\]observableInternal[/\\]|\.observe/)), u) {
        i = u;
        break;
      }
      if (!n) {
  ...
  handleOnListenerCountChanged(e, n) {
    ...
    if (i) {
      if (i.listenerCount === 0 && n > 0) {
        const s = e instanceof ve ? "observable/derived" : "observable/value";
  ...
  handleObservableUpdated(e, n) {
    ...
    const i = this._getObservableInfo(e);
    i && n.didChange && (i.lastValue = xe(n.newValue, 30), i.listenerCount > 0 && this._handleChange({
...
vs(Fs);
qt && qt.VSCODE_DEV_DEBUG && M1(Ke.getInstance());
class I {
  static fromTo(e, n) {
    return new I(e, n);
  }
  ...
  constructor(e, n) {
    if (this.start = e, this.endExclusive = n, e > n)
      throw new $(`Invalid range: ${this.toString()}`);
  }
  get isEmpty() {
  ...
  clip(e) {
    if (this.isEmpty)
      throw new $(`Invalid clipping range: ${this.toString()}`);
  ...
  joinRightTouching(e) {
    if (this.endExclusive !== e.start)
      throw new $(`Invalid join: ${this.toString()} and ${e.toString()}`);
...
class M {
  ...
  containsPosition(e) {
    return M.containsPosition(this, e);
  }
  ...
  strictContainsRange(e) {
    return M.strictContainsRange(this, e);
  }
  static strictContainsRange(e, n) {
    return !(n.startLineNumber < e.startLineNumber || n.endLineNumber < e.startLineNumber || n.startLineNumber > e.endLineNumber || n.endLineNumber > e.endLineNumber || n.startLineNumber === e.startLineNumber && n.startColumn <= e.startColumn || n.endLineNumber === e.endLineNumber && n.endColumn >= e.endColumn);
  }
  plusRange(e) {
    return M.plusRange(this, e);
  }
  ...
  intersectRanges(e) {
    return M.intersectRanges(this, e);
  }
  static intersectRanges(e, n) {
    ...
    return i < l ? (i = l, s = u) : i === l && (s = Math.max(s, u)), o > c ? (o = c, a = h) : o === c && (a = Math.min(a, h)), i > o || i === o && s > a ? null : new M(
      i,
      s,
      o,
      a
  ...
  setEndPosition(e, n) {
    return new M(this.startLineNumber, this.startColumn, e, n);
  }
  setStartPosition(e, n) {
    return new M(e, n, this.endLineNumber, this.endColumn);
  }
  collapseToStart() {
  ...
  static collapseToEnd(e) {
    return new M(e.endLineNumber, e.endColumn, e.endLineNumber, e.endColumn);
  }
  delta(e) {
    return new M(
  ...
  static fromPositions(e, n = e) {
    return new M(e.lineNumber, e.column, n.lineNumber, n.column);
  }
  static lift(e) {
    return e ? new M(
      e.startLineNumber,
    ...
    if (e && n) {
      ...
      if (o === a) {
        ...
        if (l === u) {
          ...
          if (c === h) {
            const f = e.endColumn | 0, p = n.endColumn | 0;
            return f - p;
          }
          return c - h;
        }
...
class B {
  ...
  static fromRange(e) {
    return new B(e.startLineNumber, e.endLineNumber);
  }
  static fromRangeInclusive(e) {
    return new B(e.startLineNumber, e.endLineNumber + 1);
  }
  static {
    this.compareByStart = N1((e) => e.startLineNumber, S1);
  }
  static subtract(e, n) {
    return n ? e.startLineNumber < n.startLineNumber && n.endLineNumberExclusive < e.endLineNumberExclusive ? [
      new B(e.startLineNumber, n.startLineNumber),
      new B(n.endLineNumberExclusive, e.endLineNumberExclusive)
    ] : n.startLineNumber <= e.startLineNumber && e.endLineNumberExclusive <= n.endLineNumberExclusive ? [] : n.endLineNumberExclusive < e.endLineNumberExclusive ? [new B(
      Math.max(n.endLineNumberExclusive, e.startLineNumber),
      e.endLineNumberExclusive
    )] : [new B(e.startLineNumber, Math.min(n.startLineNumber, e.endLineNumberExclusive))] : [e];
  }
  static joinMany(e) {
    if (e.length === 0)
      return [];
    let n = new Se(e[0].slice());
    for (let i = 1; i < e.length; i++)
      n = n.getUnion(new Se(e[i].slice()));
    return n.ranges;
  }
  static join(e) {
    if (e.length === 0)
      throw new $("lineRanges cannot be empty");
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new M(
  ...
  toExclusiveRange() {
    return new M(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
  }
  mapToLineArray(e) {
    const n = [];
...
class Se {
  ...
  addRange(e) {
    if (e.length === 0)
      return;
    const n = xn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= e.startLineNumber), i = jt(this._normalizedRanges, (s) => s.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(e) {
    const n = vn(this._normalizedRanges, (i) => i.startLineNumber <= e);
    return !!n && n.endLineNumberExclusive > e;
  }
  intersects(e) {
    const n = vn(this._normalizedRanges, (i) => i.startLineNumber < e.endLineNumberExclusive);
  ...
  getUnion(e) {
    ...
    for (; i < this._normalizedRanges.length || s < e._normalizedRanges.length; ) {
      ...
      o === null ? o = a : o.endLineNumberExclusive >= a.startLineNumber ? o = new B(
        o.startLineNumber,
        Math.max(o.endLineNumberExclusive, a.endLineNumberExclusive)
      ) : (n.push(o), o = a);
    }
    return o !== null && n.push(o), new Se(n);
  }
  subtractFrom(e) {
    const n = xn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber), i = jt(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === i)
      return new Se([e]);
    const s = [];
    ...
    for (let a = n; a < i; a++) {
      ...
      l.startLineNumber > o && s.push(new B(o, l.startLineNumber)), o = l.endLineNumberExclusive;
    }
    return o < e.endLineNumberExclusive && s.push(new B(o, e.endLineNumberExclusive)), new Se(s);
  }
  toString() {
  ...
  getWithDelta(e) {
    return new Se(this._normalizedRanges.map((n) => n.delta(e)));
  }
}
class js {
  constructor(e) {
  ...
  setValue(e, n) {
    return e = $e(e), n = $e(n), this.values[e] === n ? !1 : (this.values[e] = n, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
  }
  removeValues(e, n) {
    e = $e(e), n = $e(n);
  ...
  getPrefixSum(e) {
    return e < 0 ? 0 : (e = $e(e), this._getPrefixSum(e));
  }
  _getPrefixSum(e) {
...
function hn(t) {
  let e = 0, n = 0, i = 0, s = Ye.Unknown;
  for (let o = 0, a = t.length; o < a; o++) {
    const l = t.charCodeAt(o);
    l === m.CarriageReturn ? (e === 0 && (n = o), e++, o + 1 < a && t.charCodeAt(o + 1) === m.LineFeed ? (s |= Ye.CRLF, o++) : s |= Ye.Invalid, i = o + 1) : l === m.LineFeed && (s |= Ye.LF, e === 0 && (n = o), e++, i = o + 1);
  }
...
class De {
  static getLanguageId(e) {
    return (e & V.LANGUAGEID_MASK) >>> V.LANGUAGEID_OFFSET;
  }
  static getTokenType(e) {
    return (e & V.TOKEN_TYPE_MASK) >>> V.TOKEN_TYPE_OFFSET;
  }
  static containsBalancedBrackets(e) {
    return (e & V.BALANCED_BRACKETS_MASK) !== 0;
  }
  static getFontStyle(e) {
    return (e & V.FONT_STYLE_MASK) >>> V.FONT_STYLE_OFFSET;
  }
  static getForeground(e) {
    return (e & V.FOREGROUND_MASK) >>> V.FOREGROUND_OFFSET;
  }
  static getBackground(e) {
    return (e & V.BACKGROUND_MASK) >>> V.BACKGROUND_OFFSET;
  }
...
class Zs {
  ...
  register(e, n) {
    return this._tokenizationSupports.set(e, n), this.handleChange([e]), ze(() => {
  ...
  getDefaultBackground() {
    return this._colorMap && this._colorMap.length > ke.DefaultBackground ? this._colorMap[ke.DefaultBackground] : null;
  }
}
class Js extends Re {
  get isResolved() {
...
(function(t) {
  const e = /* @__PURE__ */ new Map();
  e.set(d.Method, x.symbolMethod), e.set(d.Function, x.symbolFunction), e.set(d.Constructor, x.symbolConstructor), e.set(d.Field, x.symbolField), e.set(d.Variable, x.symbolVariable), e.set(d.Class, x.symbolClass), e.set(d.Struct, x.symbolStruct), e.set(d.Interface, x.symbolInterface), e.set(d.Module, x.symbolModule), e.set(d.Property, x.symbolProperty), e.set(d.Event, x.symbolEvent), e.set(d.Operator, x.symbolOperator), e.set(d.Unit, x.symbolUnit), e.set(d.Value, x.symbolValue), e.set(d.Enum, x.symbolEnum), e.set(d.Constant, x.symbolConstant), e.set(d.Enum, x.symbolEnum), e.set(d.EnumMember, x.symbolEnumMember), e.set(d.Keyword, x.symbolKeyword), e.set(d.Snippet, x.symbolSnippet), e.set(d.Text, x.symbolText), e.set(d.Color, x.symbolColor), e.set(d.File, x.symbolFile), e.set(d.Reference, x.symbolReference), e.set(d.Customcolor, x.symbolCustomColor), e.set(d.Folder, x.symbolFolder), e.set(d.TypeParameter, x.symbolTypeParameter), e.set(d.User, x.account), e.set(d.Issue, x.issues), e.set(d.Tool, x.tools);
  function n(a) {
    let l = e.get(a);
    return l || (console.info("No codicon found for CompletionItemKind " + a), l = x.symbolProperty), l;
  }
  t.toIcon = n;
  function i(a) {
    switch (a) {
      case d.Method:
        return L(765, "Method");
      case d.Function:
        return L(766, "Function");
      case d.Constructor:
        return L(767, "Constructor");
      case d.Field:
        return L(768, "Field");
      case d.Variable:
        return L(769, "Variable");
      case d.Class:
        return L(770, "Class");
      case d.Struct:
        return L(771, "Struct");
      case d.Interface:
        return L(772, "Interface");
      case d.Module:
        return L(773, "Module");
      case d.Property:
        return L(774, "Property");
      case d.Event:
        return L(775, "Event");
      case d.Operator:
        return L(776, "Operator");
      case d.Unit:
        return L(777, "Unit");
      case d.Value:
        return L(778, "Value");
      case d.Constant:
        return L(779, "Constant");
      case d.Enum:
        return L(780, "Enum");
      case d.EnumMember:
        return L(781, "Enum Member");
      case d.Keyword:
        return L(782, "Keyword");
      case d.Text:
        return L(783, "Text");
      case d.Color:
        return L(784, "Color");
      case d.File:
        return L(785, "File");
      case d.Reference:
        return L(786, "Reference");
      case d.Customcolor:
        return L(787, "Custom Color");
      case d.Folder:
        return L(788, "Folder");
      case d.TypeParameter:
        return L(789, "Type Parameter");
      case d.User:
        return L(790, "User");
      case d.Issue:
        return L(791, "Issue");
...
g.Array + "", L(794, "array"), g.Boolean + "", L(795, "boolean"), g.Class + "", L(796, "class"), g.Constant + "", L(797, "constant"), g.Constructor + "", L(798, "constructor"), g.Enum + "", L(799, "enumeration"), g.EnumMember + "", L(800, "enumeration member"), g.Event + "", L(801, "event"), g.Field + "", L(802, "field"), g.File + "", L(803, "file"), g.Function + "", L(804, "function"), g.Interface + "", L(805, "interface"), g.Key + "", L(806, "key"), g.Method + "", L(807, "method"), g.Module + "", L(808, "module"), g.Namespace + "", L(809, "namespace"), g.Null + "", L(810, "null"), g.Number + "", L(811, "number"), g.Object + "", L(812, "object"), g.Operator + "", L(813, "operator"), g.Package + "", L(814, "package"), g.Property + "", L(815, "property"), g.String + "", L(816, "string"), g.Struct + "", L(817, "struct"), g.TypeParameter + "", L(818, "type parameter"), g.Variable + "", L(819, "variable");
var n1;
(function(t) {
  t[t.Deprecated = 1] = "Deprecated";
})(n1 || (n1 = {}));
...
(function(t) {
  const e = /* @__PURE__ */ new Map();
  e.set(g.File, x.symbolFile), e.set(g.Module, x.symbolModule), e.set(g.Namespace, x.symbolNamespace), e.set(g.Package, x.symbolPackage), e.set(g.Class, x.symbolClass), e.set(g.Method, x.symbolMethod), e.set(g.Property, x.symbolProperty), e.set(g.Field, x.symbolField), e.set(g.Constructor, x.symbolConstructor), e.set(g.Enum, x.symbolEnum), e.set(g.Interface, x.symbolInterface), e.set(g.Function, x.symbolFunction), e.set(g.Variable, x.symbolVariable), e.set(g.Constant, x.symbolConstant), e.set(g.String, x.symbolString), e.set(g.Number, x.symbolNumber), e.set(g.Boolean, x.symbolBoolean), e.set(g.Array, x.symbolArray), e.set(g.Object, x.symbolObject), e.set(g.Key, x.symbolKey), e.set(g.Null, x.symbolNull), e.set(g.EnumMember, x.symbolEnumMember), e.set(g.Struct, x.symbolStruct), e.set(g.Event, x.symbolEvent), e.set(g.Operator, x.symbolOperator), e.set(g.TypeParameter, x.symbolTypeParameter);
  function n(o) {
    let a = e.get(o);
    return a || (console.info("No codicon found for SymbolKind " + o), a = x.symbolProperty), a;
  }
  t.toIcon = n;
  const i = /* @__PURE__ */ new Map();
  i.set(g.File, d.File), i.set(g.Module, d.Module), i.set(g.Namespace, d.Module), i.set(g.Package, d.Module), i.set(g.Class, d.Class), i.set(g.Method, d.Method), i.set(g.Property, d.Property), i.set(g.Field, d.Field), i.set(g.Constructor, d.Constructor), i.set(g.Enum, d.Enum), i.set(g.Interface, d.Interface), i.set(g.Function, d.Function), i.set(g.Variable, d.Variable), i.set(g.Constant, d.Constant), i.set(g.String, d.Text), i.set(g.Number, d.Value), i.set(g.Boolean, d.Value), i.set(g.Array, d.Value), i.set(g.Object, d.Value), i.set(g.Key, d.Keyword), i.set(g.Null, d.Value), i.set(g.EnumMember, d.EnumMember), i.set(g.Struct, d.Struct), i.set(g.Event, d.Event), i.set(g.Operator, d.Operator), i.set(g.TypeParameter, d.TypeParameter);
  function s(o) {
    let a = i.get(o);
...
function er(t, e) {
  ...
  return n[0] = 0, n[1] = (t << V.LANGUAGEID_OFFSET | nn.Other << V.TOKEN_TYPE_OFFSET | Z.None << V.FONT_STYLE_OFFSET | ke.DefaultForeground << V.FOREGROUND_OFFSET | ke.DefaultBackground << V.BACKGROUND_OFFSET) >>> 0, new sn(n, e === null ? Cs : e);
}
class tr {
  constructor(e) {
  ...
  replace(e, n, i) {
    ...
    const s = this._store.slice(0, e), o = this._store.slice(e + n), a = nr(i, this._default);
  ...
  insert(e, n) {
    ...
    for (let s = 0; s < n; s++)
      i[s] = this._default;
    this._store = T1(this._store, e, i);
  }
}
function nr(t, e) {
  const n = [];
...
class Xe {
  ...
  toLineTokens(e, n) {
    return fe.createFromTextAndMetadata(this.map((i, s) => ({ text: i.substring(e), metadata: s.metadata })), n);
  }
  forEach(e) {
    let n = 0;
    for (const i of this._tokenInfo) {
      const s = new I(n, n + i.length);
      e(s, i), n += i.length;
    }
  }
  map(e) {
  ...
  slice(e) {
    ...
    for (const s of this._tokenInfo) {
      ...
      if (a > e.start) {
        ...
        n.push(new rn(s.length - l - u, s.metadata));
      }
      i += s.length;
    }
    return Xe.create(n);
...
class ir {
  ...
  add(e, n) {
    this._tokens.push(new rn(e, n));
  }
  build() {
    return Xe.create(this._tokens);
  }
}
class fe {
  static createEmpty(e, n) {
    const i = fe.defaultTokenMetadata, s = new Uint32Array(2);
    return s[0] = e.length, s[1] = i, new fe(s, e, n);
  }
  static createFromTextAndMetadata(e, n) {
    ...
    return new fe(new Uint32Array(o), s, n);
  }
  ...
  static {
    this.defaultTokenMetadata = (Z.None << V.FONT_STYLE_OFFSET | ke.DefaultForeground << V.FOREGROUND_OFFSET | ke.DefaultBackground << V.BACKGROUND_OFFSET) >>> 0;
  }
  constructor(e, n, i) {
    this._lineTokensBrand = void 0, (e.length > 1 ? e[e.length - 2] : 0) !== n.length && we(new Error("Token length and text length do not match!")), this._tokens = e, this._tokensCount = this._tokens.length >>> 1, this._text = n, this.languageIdCodec = i;
  }
  getTextLength() {
    return this._text.length;
  }
  equals(e) {
    return e instanceof fe ? this.slicedEquals(e, 0, this._tokensCount) : !1;
  }
  slicedEquals(e, n, i) {
  ...
  getLanguageId(e) {
    const n = this._tokens[(e << 1) + 1], i = De.getLanguageId(n);
    return this.languageIdCodec.decodeLanguageId(i);
  }
  getStandardTokenType(e) {
    const n = this._tokens[(e << 1) + 1];
    return De.getTokenType(n);
  }
  getForeground(e) {
    const n = this._tokens[(e << 1) + 1];
    return De.getForeground(n);
  }
  getClassName(e) {
    const n = this._tokens[(e << 1) + 1];
    return De.getClassNameFromMetadata(n);
  }
  getInlineStyle(e, n) {
    const i = this._tokens[(e << 1) + 1];
    return De.getInlineStyleFromMetadata(i, n);
  }
  getPresentation(e) {
    const n = this._tokens[(e << 1) + 1];
    return De.getPresentationFromMetadata(n);
  }
  getEndOffset(e) {
    return this._tokens[e << 1];
  }
  findTokenIndexAtOffset(e) {
    return fe.findIndexInTokensArray(this._tokens, e);
  }
  inflate() {
    return this;
  }
  sliceAndInflate(e, n, i) {
    return new _n(this, e, n, i);
  }
  sliceZeroCopy(e) {
  ...
  withInserted(e) {
    ...
    return new fe(new Uint32Array(o), s, this.languageIdCodec);
  }
  getTokensInRange(e) {
    const n = new ir(), i = this.findTokenIndexAtOffset(e.start), s = this.findTokenIndexAtOffset(e.endExclusive);
    for (let o = i; o <= s; o++) {
      const l = new I(this.getStartOffset(o), this.getEndOffset(o)).intersectionLength(e);
...
class _n {
  ...
  equals(e) {
    return e instanceof _n ? this._startOffset === e._startOffset && this._endOffset === e._endOffset && this._deltaOffset === e._deltaOffset && this._source.slicedEquals(e._source, this._firstTokenIndex, this._tokensCount) : !1;
  }
  getCount() {
    return this._tokensCount;
  }
...
const Ue = new Uint32Array(0).buffer;
class oe {
  static deleteBeginning(e, n) {
    return e === null || e === Ue ? e : oe.delete(e, 0, n);
  }
  static deleteEnding(e, n) {
    if (e === null || e === Ue)
      return e;
    const i = tt(e), s = i[i.length - 2];
    return oe.delete(e, n, s);
  }
  static delete(e, n, i) {
    if (e === null || e === Ue || n === i)
      return e;
    const s = tt(e), o = s.length >>> 1;
    if (n === 0 && s[s.length - 2] === i)
      return Ue;
    const a = fe.findIndexInTokensArray(s, n), l = a > 0 ? s[a - 1 << 1] : 0, u = s[a << 1];
    if (i < u) {
      const U = i - n;
      for (let O = a; O < o; O++)
        s[O << 1] -= U;
    ...
    let c, h;
    l !== n ? (s[a << 1] = n, c = a + 1 << 1, h = n) : (c = a << 1, h = l);
    const f = i - n;
    for (let U = a + 1; U < o; U++) {
      const O = s[U << 1] - f;
      O > h && (s[c++] = O, s[c++] = s[(U << 1) + 1], h = O);
    }
    if (c === s.length)
      return e;
    const p = new Uint32Array(c);
    return p.set(s.subarray(0, c), 0), p.buffer;
  }
  static append(e, n) {
    if (n === Ue)
      return e;
    ...
    if (n === null)
      return null;
    const i = tt(e), s = tt(n), o = s.length >>> 1, a = new Uint32Array(i.length + s.length);
    a.set(i, 0);
    let l = i.length;
  ...
  static insert(e, n, i) {
    if (e === null || e === Ue)
      return e;
    const s = tt(e), o = s.length >>> 1;
    let a = fe.findIndexInTokensArray(s, n);
    a > 0 && s[a - 1 << 1] === n && a--;
    for (let l = a; l < o; l++)
      s[l << 1] += i;
    return e;
...
class Ut {
  static deserialize(e, n, i) {
    const s = new Uint32Array(e.buffer), o = xt(e, n);
    n += 4;
    const a = xt(e, n);
    n += 4;
    const l = [];
  ...
  getLineRange() {
    return new B(this._startLineNumber, this._startLineNumber + this._tokens.length);
  }
  getLineTokens(e) {
  ...
  serialize(e, n) {
    Lt(e, this._startLineNumber, n), n += 4, Lt(e, this._tokens.length, n), n += 4;
    for (let i = 0; i < this._tokens.length; i++) {
      const s = this._tokens[i];
      if (!(s instanceof Uint32Array))
        throw new Error("Not supported!");
      Lt(e, s.byteLength, n), n += 4, e.set(new Uint8Array(s.buffer), n), n += s.byteLength;
    }
    return n;
  }
  applyEdit(e, n) {
  ...
  _acceptDeleteRange(e) {
    ...
    if (!(n >= this._tokens.length)) {
      ...
      if (n === i) {
        this._tokens[n] = oe.delete(this._tokens[n], e.startColumn - 1, e.endColumn - 1);
        return;
      }
      if (n >= 0)
        if (this._tokens[n] = oe.deleteEnding(this._tokens[n], e.startColumn - 1), i < this._tokens.length) {
          const s = oe.deleteBeginning(this._tokens[i], e.endColumn - 1);
          this._tokens[n] = oe.append(this._tokens[n], s), this._tokens.splice(n + 1, i - n);
        } else
          this._tokens[n] = oe.append(this._tokens[n], null), this._tokens = this._tokens.slice(0, n + 1);
      else {
        const s = -n;
        this._startLineNumber -= s, this._tokens[i] = oe.deleteBeginning(this._tokens[i], e.endColumn - 1), this._tokens = this._tokens.slice(i);
      }
    }
  }
  _acceptInsertText(e, n, i) {
    ...
    if (!(s >= this._tokens.length)) {
      if (n === 0) {
        this._tokens[s] = oe.insert(this._tokens[s], e.column - 1, i);
        return;
      }
      this._tokens[s] = oe.deleteEnding(this._tokens[s], e.column - 1), this._tokens[s] = oe.insert(this._tokens[s], e.column - 1, i), this._insertLines(e.lineNumber, n);
    }
  }
  _insertLines(e, n) {
    if (n === 0)
    ...
    for (let s = 0; s < n; s++)
      i[s] = null;
    this._tokens = T1(this._tokens, e, i);
  }
}
class sr {
  static deserialize(e) {
  ...
  _serialize(e) {
    let n = 0;
    Lt(e, this._tokens.length, n), n += 4;
    for (let i = 0; i < this._tokens.length; i++)
...
class rr {
  constructor(e, n) {
    this.tokenizationSupport = n, this.initialState = this.tokenizationSupport.getInitialState(), this.store = new or(e);
  }
  getStartState(e) {
...
class or {
  constructor(e) {
    this.lineCount = e, this._tokenizationStateStore = new ar(), this._invalidEndStatesLineNumbers = new lr(), this._invalidEndStatesLineNumbers.addRange(new I(1, e + 1));
  }
  getEndState(e) {
  ...
  setEndState(e, n) {
    if (!n)
      throw new $("Cannot set null/undefined state");
    this._invalidEndStatesLineNumbers.delete(e);
    const i = this._tokenizationStateStore.setEndState(e, n);
    return i && e < this.lineCount && this._invalidEndStatesLineNumbers.addRange(new I(e + 1, e + 2)), i;
  }
  acceptChange(e, n) {
    this.lineCount += n - e.length, this._tokenizationStateStore.acceptChange(e, n), this._invalidEndStatesLineNumbers.addRangeAndResize(new I(e.startLineNumber, e.endLineNumberExclusive), n);
  }
  acceptChanges(e) {
    for (const n of e) {
      const [i] = hn(n.text);
      this.acceptChange(new B(n.range.startLineNumber, n.range.endLineNumber + 1), i + 1);
    }
  }
  invalidateEndStateRange(e) {
    this._invalidEndStatesLineNumbers.addRange(new I(e.startLineNumber, e.endLineNumberExclusive));
  }
  ...
  getFirstInvalidLine(e) {
    ...
    if (!i)
      throw new $("Start state must be defined");
    return { lineNumber: n, startState: i };
  }
}
class ar {
  constructor() {
    this._lineEndStates = new tr(null);
  }
  getEndState(e) {
...
class lr {
  ...
  removeMin() {
    ...
    return e.start + 1 === e.endExclusive ? this._ranges.shift() : this._ranges[0] = new I(e.start + 1, e.endExclusive), e.start;
  }
  delete(e) {
    const n = this._ranges.findIndex((i) => i.contains(e));
    if (n !== -1) {
      const i = this._ranges[n];
      i.start === e ? i.endExclusive === e + 1 ? this._ranges.splice(n, 1) : this._ranges[n] = new I(e + 1, i.endExclusive) : i.endExclusive === e + 1 ? this._ranges[n] = new I(i.start, e) : this._ranges.splice(n, 1, new I(i.start, e), new I(e + 1, i.endExclusive));
    }
  }
  addRange(e) {
    I.addRange(e, this._ranges);
  }
  addRangeAndResize(e, n) {
    ...
    if (i === s) {
      const a = new I(e.start, e.start + n);
      a.isEmpty || this._ranges.splice(i, 0, a);
    } else {
      const a = Math.min(e.start, this._ranges[i].start), l = Math.max(e.endExclusive, this._ranges[s - 1].endExclusive), u = new I(a, l + o);
...
class ur extends Re {
  ...
  tokenizeEncoded(e, n, i) {
    const s = Math.random() * 1e4 < 1, o = this._reportSlowTokenization || s, a = o ? new Dt(!0) : void 0, l = this._grammar.tokenizeLine2(e, i, 500);
    if (o) {
      const c = a.elapsed();
      (s || c > 32) && this._reportTokenizationTime(c, e.length, s);
    }
    if (l.stoppedEarly)
      return console.warn(`Time limit reached when tokenizing line: ${e.substring(0, 100)}`), new sn(l.tokens, i);
    if (this._containsEmbeddedLanguages) {
      const c = this._seenLanguages, h = l.tokens;
      for (let f = 0, p = h.length >>> 1; f < p; f++) {
        const U = h[(f << 1) + 1], O = De.getLanguageId(U);
        c[O] || (c[O] = !0, this._onDidEncounterLanguage.fire(O));
      }
    }
    let u;
    return i.equals(l.ruleStack) ? u = i : u = l.ruleStack, new sn(l.tokens, u);
  }
}
class cr extends Re {
  get backgroundTokenizerShouldOnlyVerifyTokens() {
  ...
  constructor(e, n, i, s) {
    super(), this._encodedLanguageId = e, this._actual = n, this._maxTokenizationLineLength = s, this._register($1(this._maxTokenizationLineLength)), this._register(i);
  }
  getInitialState() {
  ...
  tokenizeEncoded(e, n, i) {
    return e.length >= this._maxTokenizationLineLength.get() ? er(this._encodedLanguageId, i) : this._actual.tokenizeEncoded(e, n, i);
  }
  createBackgroundTokenizer(e, n) {
...
class dr extends Ys {
  constructor(e, n, i, s, o, a, l, u) {
    super(e, n, i, s), this._host = o, this._languageId = a, this._encodedLanguageId = l, this._tokenizerWithStateStore = null, this._isDisposed = !1, this._maxTokenizationLineLength = Is(this, -1), this._tokenizeDebouncer = new Es(() => this._tokenize(), 10), this._maxTokenizationLineLength.set(u, void 0), this._resetTokenization();
  }
  dispose() {
    this._isDisposed = !0, super.dispose();
  }
  ...
  retokenize(e, n) {
    this._tokenizerWithStateStore && (this._tokenizerWithStateStore.store.invalidateEndStateRange(new B(e, n)), this._tokenizeDebouncer.schedule());
  }
  async _resetTokenization() {
    ...
    if (!(this._isDisposed || e !== this._languageId || n !== this._encodedLanguageId || !i)) {
      if (i.grammar) {
        const s = new cr(this._encodedLanguageId, new ur(
          i.grammar,
          i.initialState,
          !1,
          void 0,
          ...
          !1
        ), Re.None, this._maxTokenizationLineLength);
        this._tokenizerWithStateStore = new rr(this._lines.length, s);
      } else
        this._tokenizerWithStateStore = null;
      this._tokenize();
    }
  ...
  async _tokenize() {
    ...
    if (!this._diffStateStacksRefEqFn) {
      const { diffStateStacksRefEq: n } = await import("./main-0Kj9FqTw.js").then(function(i) {
        return i.m;
      }).then((i) => i.default ?? i);
    ...
    for (; ; ) {
      ...
      for (; ; ) {
        ...
        if (fe.convertToEndOffset(c.tokens, u.length), i.add(l.lineNumber, c.tokens), (/* @__PURE__ */ new Date()).getTime() - e > 20)
          break;
      }
      if (n === 0)
        break;
...
class It {
  ...
  static getChannel(e) {
    return e.getChannel(It.CHANNEL_NAME);
  }
  static setChannel(e, n) {
    e.setChannel(It.CHANNEL_NAME, n);
  }
}
function hr(t) {
  return new _r(t);
...
class _r {
  constructor(e) {
    this._models = /* @__PURE__ */ new Map(), this._grammarCache = [], this._grammarFactory = Promise.resolve(null), this._host = It.getChannel(e);
  }
  async $init(e) {
    const n = e.grammarDefinitions.map((i) => ({
      location: j.revive(i.location),
      language: i.language,
  ...
  async _loadTMGrammarFactory(e, n) {
    const i = await import("./main-0Kj9FqTw.js").then(function(u) {
      return u.m;
    }).then((u) => u.default ?? u), s = await import("./main-CECPNHtY.js").then(function(u) {
      return u.m;
  ...
  $acceptNewModel(e) {
    const n = j.revive(e.uri), i = this;
    this._models.set(e.controllerId, new dr(n, e.lines, e.EOL, e.versionId, {
...
const Gt = "default", gr = "$initialize";
var ne;
(function(t) {
...
class vr {
  ...
  sendMessage(e, n, i) {
    ...
    return new Promise((o, a) => {
      this._pendingReplies[s] = {
        resolve: o,
        reject: a
      }, this._send(new mr(this._workerId, s, e, n, i));
    });
  }
  listen(e, n, i) {
    let s = null;
    const o = new ae({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, o), this._send(new br(this._workerId, s, e, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(s), this._send(new Er(this._workerId, s)), s = null;
      }
    });
    return o.event;
  }
  ...
  createProxyToRemoteChannel(e, n) {
    const i = {
      get: (s, o) => (typeof o == "string" && !s[o] && (K1(o) ? s[o] = (a) => this.listen(e, o, a) : j1(o) ? s[o] = this.listen(e, o, void 0) : o.charCodeAt(0) === m.DollarSign && (s[o] = async (...a) => (await n?.(), this.sendMessage(e, o, a)))), s[o])
    };
  ...
  _handleRequestMessage(e) {
    ...
    this._handler.handleMessage(e.channel, e.method, e.args).then((s) => {
      this._send(new m1(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = Kt(s.detail)), this._send(new m1(this._workerId, n, void 0, Kt(s)));
    });
  }
  _handleSubscribeEventMessage(e) {
    const n = e.req, i = this._handler.handleEvent(e.channel, e.eventName, e.arg)((s) => {
      this._send(new pr(this._workerId, n, s));
    });
...
function j1(t) {
  return t[0] === "o" && t[1] === "n" && D1(t.charCodeAt(2));
}
function K1(t) {
  return /^onDynamic/.test(t) && D1(t.charCodeAt(9));
}
class xr {
  constructor(e, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new vr({
      sendMessage: (i, s) => {
        e(i, s);
      },
  ...
  _handleMessage(e, n, i) {
    ...
    const s = e === Gt ? this.requestHandler : this._localChannels.get(e);
    if (!s)
...
wr(hr);
//# sourceMappingURL=worker-we-hJcV2.js.map
